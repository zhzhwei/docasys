...
class AnwendungsfallTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function getAuslegungenReturnsInitialValueForAuslegung()
    {
        $newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        self::assertEquals(
            $newObjectStorage,
     ...
     * @test
     */
    public function setAuslegungenForObjectStorageContainingAuslegungSetsAuslegungen()
    {
        $auslegungen = new \Wise\WiseDocasysDomainDesigner\Domain\Model\Auslegung();
