...
return [
    'ctrl' => [
		...
		'searchFields' => 'spannweite,bemerkung,wirkungsgradtendenz,wirkungsziel',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, spannweite, bemerkung, wirkungsgradtendenz, wirkungsziel',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, spannweite, bemerkung, wirkungsgradtendenz, wirkungsziel, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
        ...
        'spannweite' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_auswirkung.spannweite',
	        'config' => [
			    'type' => 'input',
			    'size' => 30,
			    'eval' => 'trim'
