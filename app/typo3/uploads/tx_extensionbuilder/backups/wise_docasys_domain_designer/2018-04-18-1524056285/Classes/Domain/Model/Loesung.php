...
class Loesung extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * @cascade remove
     */
    protected $entscheidungsmodell = null;
    ...
    {
        $this->prozessmodell = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        $this->entscheidungsmodell = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
     ...
     * @return void
     */
    public function addProzessmodell(\TYPO3\CMS\Extbase\Domain\Model\FileReference $prozessmodell)
    {
        $this->prozessmodell->attach($prozessmodell);
    }

    /**
     * Removes a FileReference
     * 
     * @param \TYPO3\CMS\Extbase\Domain\Model\FileReference $prozessmodellToRemove The FileReference to be removed
     * @return void
     */
    public function removeProzessmodell(\TYPO3\CMS\Extbase\Domain\Model\FileReference $prozessmodellToRemove)
    {
        $this->prozessmodell->detach($prozessmodellToRemove);
    }

    /**
     * Returns the prozessmodell
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\TYPO3\CMS\Extbase\Domain\Model\FileReference> $prozessmodell
     */
     ...
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\TYPO3\CMS\Extbase\Domain\Model\FileReference> $prozessmodell
     * @return void
     */
    public function setProzessmodell(\TYPO3\CMS\Extbase\Persistence\ObjectStorage $prozessmodell)
    {
     ...
     * Adds a FileReference
     * 
     * @param \TYPO3\CMS\Extbase\Domain\Model\FileReference $entscheidungsmodell
     * @return void
     */
    public function addEntscheidungsmodell(\TYPO3\CMS\Extbase\Domain\Model\FileReference $entscheidungsmodell)
    {
        $this->entscheidungsmodell->attach($entscheidungsmodell);
    }

    /**
     * Removes a FileReference
     * 
     * @param \TYPO3\CMS\Extbase\Domain\Model\FileReference $entscheidungsmodellToRemove The FileReference to be removed
     * @return void
     */
    public function removeEntscheidungsmodell(\TYPO3\CMS\Extbase\Domain\Model\FileReference $entscheidungsmodellToRemove)
    {
        $this->entscheidungsmodell->detach($entscheidungsmodellToRemove);
    }

    /**
     * Returns the entscheidungsmodell
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\TYPO3\CMS\Extbase\Domain\Model\FileReference> $entscheidungsmodell
     */
    public function getEntscheidungsmodell()
    {
        return $this->entscheidungsmodell;
    }

    /**
     * Sets the entscheidungsmodell
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\TYPO3\CMS\Extbase\Domain\Model\FileReference> $entscheidungsmodell
     * @return void
     */
    public function setEntscheidungsmodell(\TYPO3\CMS\Extbase\Persistence\ObjectStorage $entscheidungsmodell)
    {
        $this->entscheidungsmodell = $entscheidungsmodell;
    }
}
