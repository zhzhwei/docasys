...
class Lastfallpruefung extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
    ...
    {
        $this->pruefprotokoll = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
    }

    /**
     * Adds a FileReference
     * 
     * @param \TYPO3\CMS\Extbase\Domain\Model\FileReference $pruefprotokoll
     * @return void
     */
    public function addPruefprotokoll(\TYPO3\CMS\Extbase\Domain\Model\FileReference $pruefprotokoll)
    {
        $this->pruefprotokoll->attach($pruefprotokoll);
    }

    /**
     * Removes a FileReference
     * 
     * @param \TYPO3\CMS\Extbase\Domain\Model\FileReference $pruefprotokollToRemove The FileReference to be removed
     * @return void
     */
    public function removePruefprotokoll(\TYPO3\CMS\Extbase\Domain\Model\FileReference $pruefprotokollToRemove)
    {
        $this->pruefprotokoll->detach($pruefprotokollToRemove);
    }

    /**
     * Returns the pruefprotokoll
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\TYPO3\CMS\Extbase\Domain\Model\FileReference> $pruefprotokoll
     */
    public function getPruefprotokoll()
    {
        return $this->pruefprotokoll;
    }

    /**
     * Sets the pruefprotokoll
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\TYPO3\CMS\Extbase\Domain\Model\FileReference> $pruefprotokoll
     * @return void
     */
    public function setPruefprotokoll(\TYPO3\CMS\Extbase\Persistence\ObjectStorage $pruefprotokoll)
    {
        $this->pruefprotokoll = $pruefprotokoll;
    }
}
