...
class LoesungTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function getProzessmodellReturnsInitialValueForFileReference()
    {
        $newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        self::assertEquals(
            $newObjectStorage,
            $this->subject->getProzessmodell()
        );
     ...
     * @test
     */
    public function setProzessmodellForFileReferenceSetsProzessmodell()
    {
        $prozessmodell = new \TYPO3\CMS\Extbase\Domain\Model\FileReference();
        $objectStorageHoldingExactlyOneProzessmodell = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        $objectStorageHoldingExactlyOneProzessmodell->attach($prozessmodell);
        $this->subject->setProzessmodell($objectStorageHoldingExactlyOneProzessmodell);

        self::assertAttributeEquals(
            $objectStorageHoldingExactlyOneProzessmodell,
            'prozessmodell',
            $this->subject
        );
     ...
     * @test
     */
    public function addProzessmodellToObjectStorageHoldingProzessmodell()
    {
        $prozessmodell = new \TYPO3\CMS\Extbase\Domain\Model\FileReference();
        $prozessmodellObjectStorageMock = $this->getMockBuilder(\TYPO3\CMS\Extbase\Persistence\ObjectStorage::class)
            ->setMethods(['attach'])
            ->disableOriginalConstructor()
            ->getMock();

        $prozessmodellObjectStorageMock->expects(self::once())->method('attach')->with(self::equalTo($prozessmodell));
        $this->inject($this->subject, 'prozessmodell', $prozessmodellObjectStorageMock);

        $this->subject->addProzessmodell($prozessmodell);
    }

    /**
     * @test
     */
    public function removeProzessmodellFromObjectStorageHoldingProzessmodell()
    {
        $prozessmodell = new \TYPO3\CMS\Extbase\Domain\Model\FileReference();
        $prozessmodellObjectStorageMock = $this->getMockBuilder(\TYPO3\CMS\Extbase\Persistence\ObjectStorage::class)
            ->setMethods(['detach'])
        ...
        $prozessmodellObjectStorageMock->expects(self::once())->method('detach')->with(self::equalTo($prozessmodell));
        $this->inject($this->subject, 'prozessmodell', $prozessmodellObjectStorageMock);

        $this->subject->removeProzessmodell($prozessmodell);
     ...
     * @test
     */
    public function getEntscheidungsmodellReturnsInitialValueForFileReference()
    {
        $newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        self::assertEquals(
            $newObjectStorage,
            $this->subject->getEntscheidungsmodell()
        );
     ...
     * @test
     */
    public function setEntscheidungsmodellForFileReferenceSetsEntscheidungsmodell()
    {
        $entscheidungsmodell = new \TYPO3\CMS\Extbase\Domain\Model\FileReference();
        $objectStorageHoldingExactlyOneEntscheidungsmodell = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        $objectStorageHoldingExactlyOneEntscheidungsmodell->attach($entscheidungsmodell);
        $this->subject->setEntscheidungsmodell($objectStorageHoldingExactlyOneEntscheidungsmodell);

        self::assertAttributeEquals(
            $objectStorageHoldingExactlyOneEntscheidungsmodell,
            'entscheidungsmodell',
            $this->subject
        );
     ...
     * @test
     */
    public function addEntscheidungsmodellToObjectStorageHoldingEntscheidungsmodell()
    {
        $entscheidungsmodell = new \TYPO3\CMS\Extbase\Domain\Model\FileReference();
        $entscheidungsmodellObjectStorageMock = $this->getMockBuilder(\TYPO3\CMS\Extbase\Persistence\ObjectStorage::class)
            ->setMethods(['attach'])
            ->disableOriginalConstructor()
            ->getMock();

        $entscheidungsmodellObjectStorageMock->expects(self::once())->method('attach')->with(self::equalTo($entscheidungsmodell));
        $this->inject($this->subject, 'entscheidungsmodell', $entscheidungsmodellObjectStorageMock);

        $this->subject->addEntscheidungsmodell($entscheidungsmodell);
    }

    /**
     * @test
     */
    public function removeEntscheidungsmodellFromObjectStorageHoldingEntscheidungsmodell()
    {
        $entscheidungsmodell = new \TYPO3\CMS\Extbase\Domain\Model\FileReference();
        $entscheidungsmodellObjectStorageMock = $this->getMockBuilder(\TYPO3\CMS\Extbase\Persistence\ObjectStorage::class)
            ->setMethods(['detach'])
        ...
        $entscheidungsmodellObjectStorageMock->expects(self::once())->method('detach')->with(self::equalTo($entscheidungsmodell));
        $this->inject($this->subject, 'entscheidungsmodell', $entscheidungsmodellObjectStorageMock);

        $this->subject->removeEntscheidungsmodell($entscheidungsmodell);
     ...
     * @test
     */
    public function getErforderlichesModellReturnsInitialValueForModell()
    {
        $newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        self::assertEquals(
            $newObjectStorage,
     ...
     * @test
     */
    public function setErforderlichesModellForObjectStorageContainingModellSetsErforderlichesModell()
    {
        $erforderlichesModell = new \Wise\WiseDocasysDomainDesigner\Domain\Model\Modell();
