...
return [
    ...
    'types' => [
		'1' => ['showitem' => '
            --div--;Allgemeines, l10n_parent, l10n_diffsource, hidden, bezeichnung, beschreibung,
            --div--;Technologie, fertigungsflexibilitaet, zerspanvolumen,
            --div--;Werkzeuge, werkzeuganzahl, werkzeugwechselanteil, werkzeugwechselhaeufigkeit, werkzeuge,
            --div--;Lastfälle, lastfall'
        ],
    ],
    'columns' => [
		'sys_language_uid' => [
