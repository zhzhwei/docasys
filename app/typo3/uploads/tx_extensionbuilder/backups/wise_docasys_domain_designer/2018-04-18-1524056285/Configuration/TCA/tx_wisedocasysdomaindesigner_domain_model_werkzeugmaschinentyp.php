...
return [
    ...
    'types' => [
		'1' => ['showitem' => '
            --div--; Allgemein, l10n_parent, l10n_diffsource, hidden, typbezeichnung, einsatzzweck, 
            --div--; Komponenten, steuerungstyp, antrieb, fuerung, gestell, werkzeugsystem, sonstige, eigenschaften, 
        '],
    ],
    'columns' => [
		'sys_language_uid' => [
