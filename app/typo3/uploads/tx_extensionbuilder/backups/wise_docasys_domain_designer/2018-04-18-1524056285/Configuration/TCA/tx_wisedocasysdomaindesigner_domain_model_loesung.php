<?php
    return [
        'ctrl' => [
            ...
            'searchFields' => 'loesungsbezeichnung,teilprojektnummer,gestaltungsweise,betrifft_hersteller,betrifft_betreiber,bemerkung,risiko,blocker,loesungsklasse,phase_der_thermischen_wirkkette,gestaltungsart,prozessmodell,wirkungsziel,erforderliche_maschinenkonfiguration,ressourcentyp,repraesentativer_lastfall,erforderliches_modell, entscheidungsmodell',
            'iconfile' => 'EXT:wise_docasys_domain_designer/Resources/Public/Icons/tx_wisedocasysdomaindesigner_domain_model_loesung.gif'
        ],
        'interface' => [
            'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, loesungsbezeichnung, teilprojektnummer, gestaltungsweise, betrifft_hersteller, betrifft_betreiber, bemerkung, risiko, blocker, loesungsklasse, phase_der_thermischen_wirkkette, gestaltungsart, prozessmodell, entscheidungsmodell, wirkungsziel, erforderliche_maschinenkonfiguration, ressourcentyp, repraesentativer_lastfall, erforderliches_modell',
        ],
        'types' => [
            '1' => ['showitem' => '
                --div--; Allgemein, sys_language_uid, l10n_parent, l10n_diffsource, hidden, loesungsbezeichnung, teilprojektnummer, bemerkung,
                --div--; Wirkung und Einordnung, loesungsklasse, wirkungsziel, phase_der_thermischen_wirkkette, gestaltungsart, gestaltungsweise, betrifft_hersteller, betrifft_betreiber, 
                --div--; Anwendungsdokumentation, prozessmodell, entscheidungsmodell,
                --div--; Abhängigkeiten, erforderliche_maschinenkonfiguration, ressourcentyp, erforderliches_modell,
                --div--; Risiken, risiko, blocker,   
                --div--; Lastfälle, repraesentativer_lastfall
            '],
        ],
        'columns' => [
            'sys_language_uid' => [
            ...
            'prozessmodell' => [
                'exclude' => true,
                'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_loesung.prozessmodell',
            ...
            'entscheidungsmodell' => [
                'exclude' => true,
                'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_loesung.entscheidungsmodell',
                'config' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::getFileFieldTCAConfig(
                    'document', [
                        'appearance' => [
                            'createNewRelationLinkTitle' => 'LLL:EXT:cms/locallang_ttc.xlf:media.addFileReference'
