    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_wisedocasysdomaindesigner_domain_model_parameterpruefergebnis.pid=###CURRENT_PID### AND tx_wisedocasysdomaindesigner_domain_model_parameterpruefergebnis.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
	    ...
	    'messparameter' => [
	        ...
	        'config' => [
			    ...
			    'foreign_field' => 'parameterpruefergebnis',
			    'maxitems' => 9999,
			    'appearance' => [
			        'collapseAll' => 0,
