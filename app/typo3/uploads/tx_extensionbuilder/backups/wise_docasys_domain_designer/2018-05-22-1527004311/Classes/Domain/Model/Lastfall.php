...
class Lastfall extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * 
     * @param  $empfohlenePrfueverfahren
     * @return void
     */
    public function addEmpfohlenePrfueverfahren($empfohlenePrfueverfahren)
    {
     ...
     * 
     * @param  $empfohlenePrfueverfahrenToRemove The  to be removed
     * @return void
     */
    public function removeEmpfohlenePrfueverfahren($empfohlenePrfueverfahrenToRemove)
    {
     ...
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<> empfohlenePrfueverfahren
     */
     ...
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<> $empfohlenePrfueverfahren
     * @return void
     */
