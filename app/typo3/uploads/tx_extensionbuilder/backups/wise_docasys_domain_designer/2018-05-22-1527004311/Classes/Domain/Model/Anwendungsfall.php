...
class Anwendungsfall extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * @return void
     */
    public function addAuslegungen($auslegungen)
    {
     ...
     * 
     * @param  $auslegungenToRemove The  to be removed
     * @return void
     */
    public function removeAuslegungen($auslegungenToRemove)
    {
     ...
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<> auslegungen
     */
     ...
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<> $auslegungen
     * @return void
     */
