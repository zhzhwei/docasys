...
return [
    'ctrl' => [
		...
		'searchFields' => 'typbezeichnung,einsatzzweck,eigenschaften,komponente_antriebstyp,komponente_fuehrungstyp,komponente_gestelltyp,komponente_lagertyp,komponente_getrieb,komponente_messsystem,steuerungstyp,antrieb,fuerung,gestell,werkzeugsystem,sonstige',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, typbezeichnung, einsatzzweck, eigenschaften, komponente_antriebstyp, komponente_fuehrungstyp, komponente_gestelltyp, komponente_lagertyp, komponente_getrieb, komponente_messsystem, steuerungstyp, antrieb, fuerung, gestell, werkzeugsystem, sonstige',
    ],
    'types' => [
        // '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, typbezeichnung, einsatzzweck, eigenschaften, komponente_antriebstyp, komponente_fuehrungstyp, komponente_gestelltyp, komponente_lagertyp, komponente_getrieb, komponente_messsystem, steuerungstyp, antrieb, fuerung, gestell, werkzeugsystem, sonstige, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
		'1' => ['showitem' => 'l10n_parent, l10n_diffsource, hidden, typbezeichnung, einsatzzweck, eigenschaften, komponente_antriebstyp, komponente_fuehrungstyp, komponente_gestelltyp, komponente_lagertyp, komponente_getrieb, komponente_messsystem, steuerungstyp, antrieb, fuerung, gestell, werkzeugsystem, sonstige'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'komponente_antriebstyp' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_werkzeugmaschinentyp.komponente_antriebstyp',
	        'config' => [
			    'type' => 'input',
			    'size' => 30,
			    'eval' => 'trim'
	    ...
	    'komponente_fuehrungstyp' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_werkzeugmaschinentyp.komponente_fuehrungstyp',
	        'config' => [
			    'type' => 'input',
			    'size' => 30,
			    'eval' => 'trim'
	    ...
	    'komponente_gestelltyp' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_werkzeugmaschinentyp.komponente_gestelltyp',
	        'config' => [
			    'type' => 'input',
			    'size' => 30,
			    'eval' => 'trim'
	    ...
	    'komponente_lagertyp' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_werkzeugmaschinentyp.komponente_lagertyp',
	        'config' => [
			    'type' => 'input',
			    'size' => 30,
			    'eval' => 'trim'
	    ...
	    'komponente_getrieb' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_werkzeugmaschinentyp.komponente_getrieb',
	        'config' => [
			    'type' => 'input',
			    'size' => 30,
			    'eval' => 'trim'
	    ...
	    'komponente_messsystem' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_werkzeugmaschinentyp.komponente_messsystem',
	        'config' => [
			    'type' => 'input',
			    'size' => 30,
			    'eval' => 'trim'
