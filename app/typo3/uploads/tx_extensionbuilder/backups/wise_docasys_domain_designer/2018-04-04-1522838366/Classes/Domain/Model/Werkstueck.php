...
class Werkstueck extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
    ...
    /**
     * Returns the kantaenge
     * 
     * @return string $kantaenge
     */
    public function getKantaenge()
    {
        return $this->kantaenge;
    }

    /**
     * Sets the kantaenge
     * 
     * @param string $kantaenge
     * @return void
     */
    public function setKantaenge($kantaenge)
    {
        $this->kantaenge = $kantaenge;
    }
