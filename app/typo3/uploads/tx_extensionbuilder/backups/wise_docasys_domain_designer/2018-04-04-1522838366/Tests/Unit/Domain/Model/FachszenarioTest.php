...
class FachszenarioTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function getAnwendungsfallReturnsInitialValueForAnwendungsfall()
    {
     ...
     * @test
     */
    public function setAnwendungsfallForObjectStorageContainingAnwendungsfallSetsAnwendungsfall()
    {
        $anwendungsfall = new \Wise\WiseDocasysDomainDesigner\Domain\Model\Anwendungsfall();
