...
class LoesungsuntersuchungTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function getUntersuchungsmethodeReturnsInitialValueForUntersuchungsmethode()
    {
     ...
     * @test
     */
    public function setUntersuchungsmethodeForObjectStorageContainingUntersuchungsmethodeSetsUntersuchungsmethode()
    {
        $untersuchungsmethode = new \Wise\WiseDocasysDomainDesigner\Domain\Model\Untersuchungsmethode();
