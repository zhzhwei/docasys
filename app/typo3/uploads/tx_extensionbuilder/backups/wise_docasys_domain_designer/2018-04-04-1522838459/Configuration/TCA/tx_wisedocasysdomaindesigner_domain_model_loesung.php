...
return [
    'ctrl' => [
		...
		'searchFields' => 'loesungsbezeichnung,teilprojektnummer,gestaltungsweise,betrifft_hersteller,betrifft_betreiber,bemerkung,risiko,blocker,loesungsklasse,phase_der_thermischen_wirkkette,gestaltungsart,prozessmodell,wirkungsziel,erforderliche_maschinenkonfiguration,ressourcentyp,repraesentativer_lastfall,erforderliches_modell',
    ...
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, loesungsbezeichnung, teilprojektnummer, gestaltungsweise, betrifft_hersteller, betrifft_betreiber, bemerkung, risiko, blocker, loesungsklasse, phase_der_thermischen_wirkkette, gestaltungsart, prozessmodell, wirkungsziel, erforderliche_maschinenkonfiguration, ressourcentyp, repraesentativer_lastfall, erforderliches_modell, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
