...
return [
    'ctrl' => [
		...
		'searchFields' => 'modellbezeichnung,anfangsbedingungen,modellierungszweck,randbedingungen,erforderliche_modellguete,modellierungssoftware,modelltyp,abbildungsbereich,modellumfang,modellstruktur,parametrierungsart,erforderliches_modell',
        'iconfile' => 'EXT:wise_docasys_domain_designer/Resources/Public/Icons/tx_wisedocasysdomaindesigner_domain_model_modell.gif'
    ],
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, modellbezeichnung, anfangsbedingungen, modellierungszweck, randbedingungen, erforderliche_modellguete, modellierungssoftware, modelltyp, abbildungsbereich, modellumfang, modellstruktur, parametrierungsart, erforderliches_modell',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, modellbezeichnung, anfangsbedingungen, modellierungszweck, randbedingungen, erforderliche_modellguete, modellierungssoftware, modelltyp, abbildungsbereich, modellumfang, modellstruktur, parametrierungsart, erforderliches_modell, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'erforderliches_modell' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_modell.erforderliches_modell',
	        'config' => [
			    'type' => 'inline',
