...
return [
    'ctrl' => [
		...
		'searchFields' => 'loesungsbezeichnung,teilprojektnummer,gestaltungsweise,betrifft_hersteller,betrifft_betreiber,bemerkung,risiko,blocker,loesungsklasse,phase_der_thermischen_wirkkette,gestaltungsart,wirkungsziel,werkzeugmaschinentyp,ressourcentyp',
        'iconfile' => 'EXT:wise_docasys_domain_designer/Resources/Public/Icons/tx_wisedocasysdomaindesigner_domain_model_loesung.gif'
    ],
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, loesungsbezeichnung, teilprojektnummer, gestaltungsweise, betrifft_hersteller, betrifft_betreiber, bemerkung, risiko, blocker, loesungsklasse, phase_der_thermischen_wirkkette, gestaltungsart, wirkungsziel, werkzeugmaschinentyp, ressourcentyp',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, loesungsbezeichnung, teilprojektnummer, gestaltungsweise, betrifft_hersteller, betrifft_betreiber, bemerkung, risiko, blocker, loesungsklasse, phase_der_thermischen_wirkkette, gestaltungsart, wirkungsziel, werkzeugmaschinentyp, ressourcentyp, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'werkzeugmaschinentyp' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_loesung.werkzeugmaschinentyp',
	        'config' => [
			    'type' => 'inline',
