...
class Anwendungsfall extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * auslegungen
     * 
     * @var \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\Auslegung>
     */
     ...
     * 
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\Auslegung $auslegungen
     * @return void
     */
    public function addAuslegungen(\Wise\WiseDocasysDomainDesigner\Domain\Model\Auslegung $auslegungen)
    {
     ...
     * 
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\Auslegung $auslegungenToRemove The Auslegung to be removed
     * @return void
     */
    public function removeAuslegungen(\Wise\WiseDocasysDomainDesigner\Domain\Model\Auslegung $auslegungenToRemove)
    {
     ...
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\Auslegung> auslegungen
     */
     ...
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\Auslegung> $auslegungen
     * @return void
     */
