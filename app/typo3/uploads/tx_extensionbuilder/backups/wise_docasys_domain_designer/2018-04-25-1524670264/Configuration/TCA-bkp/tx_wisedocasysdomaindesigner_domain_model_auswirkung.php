...
return [
    'ctrl' => [
        ...
        'label' => 'spannweite',
        'label_userFunc' => 'Wise\\WiseDocasysDomainDesigner\\Userfuncs\\Tca->auswirkungTitle',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        'sortby' => 'sorting',
    ...
    'types' => [
		'1' => ['showitem' => '
            --div--; Allgemein, l10n_parent, l10n_diffsource, hidden, spannweite, bemerkung, 
            --div--; Wirkung, wirkungsgradtendenz, wirkungsziel
        '],
    ],
    'columns' => [
		'sys_language_uid' => [
