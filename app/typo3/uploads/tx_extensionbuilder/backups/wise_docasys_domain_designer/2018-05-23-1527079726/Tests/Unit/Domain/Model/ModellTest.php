...
class ModellTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function setModelliertForKomponententypSetsModelliert()
    {
        $modelliertFixture = new \Wise\WiseDocasysDomainDesigner\Domain\Model\Komponententyp();
        $this->subject->setModelliert($modelliertFixture);
