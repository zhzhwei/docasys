<?php
    return [
        'ctrl' => [
            ...
            'searchFields' => 'bemerkung,ressource,struktur,ist_obligatorisch',
        ...
        'interface' => [
            'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bemerkung, ressource, struktur, ist_obligatorisch',
        ],
        'types' => [
            '1' => ['showitem' => '
                l10n_parent, l10n_diffsource, ressource, struktur, ist_obligatorisch, bemerkung,
            '],
        ],
        'columns' => [
            'sys_language_uid' => [
