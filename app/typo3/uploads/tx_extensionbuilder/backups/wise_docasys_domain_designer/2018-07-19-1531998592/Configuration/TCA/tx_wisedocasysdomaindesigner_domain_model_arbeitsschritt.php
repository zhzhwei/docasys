...
return [
    'ctrl' => [
		...
		'searchFields' => 'bezeichnung,beschreibung,ist_optional,dauer_in_tagen,dauer_in_tagen_von,dauer_in_tagen_bis,verbesserungspotential_realbetrieb,arbeitsschrittart,bestandteile,erforderliche_ressourcen,erforderliche_messmittel,erforderliche_modelle',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, beschreibung, ist_optional, dauer_in_tagen, dauer_in_tagen_von, dauer_in_tagen_bis, verbesserungspotential_realbetrieb, arbeitsschrittart, bestandteile, erforderliche_ressourcen, erforderliche_messmittel, erforderliche_modelle',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, beschreibung, ist_optional, dauer_in_tagen, dauer_in_tagen_von, dauer_in_tagen_bis, verbesserungspotential_realbetrieb, arbeitsschrittart, bestandteile, erforderliche_ressourcen, erforderliche_messmittel, erforderliche_modelle, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
