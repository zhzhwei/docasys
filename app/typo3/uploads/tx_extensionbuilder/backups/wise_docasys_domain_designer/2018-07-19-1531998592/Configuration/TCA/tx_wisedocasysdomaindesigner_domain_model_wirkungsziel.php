...
return [
    'ctrl' => [
		...
		'searchFields' => 'zielbezeichnung,beschreibung,einheit,wertebereich,quantifizierbarkeit,erreichbare_genauigkeit',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, zielbezeichnung, beschreibung, einheit, wertebereich, quantifizierbarkeit, erreichbare_genauigkeit',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, zielbezeichnung, beschreibung, einheit, wertebereich, quantifizierbarkeit, erreichbare_genauigkeit, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'erreichbare_genauigkeit' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_wirkungsziel.erreichbare_genauigkeit',
	        'config' => [
			    'type' => 'text',
			    'cols' => 40,
			    'rows' => 15,
