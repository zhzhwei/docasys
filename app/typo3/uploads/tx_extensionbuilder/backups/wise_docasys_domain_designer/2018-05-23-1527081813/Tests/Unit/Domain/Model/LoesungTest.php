...
class LoesungTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function getInputMessmitellReturnsInitialValueForLsgMessmittelInput()
    {
        $newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        self::assertEquals(
            $newObjectStorage,
            $this->subject->getInputMessmitell()
        );
     ...
     * @test
     */
    public function setInputMessmitellForObjectStorageContainingLsgMessmittelInputSetsInputMessmitell()
    {
        $inputMessmitell = new \Wise\WiseDocasysDomainDesigner\Domain\Model\LsgMessmittelInput();
        $objectStorageHoldingExactlyOneInputMessmitell = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        $objectStorageHoldingExactlyOneInputMessmitell->attach($inputMessmitell);
        $this->subject->setInputMessmitell($objectStorageHoldingExactlyOneInputMessmitell);

        self::assertAttributeEquals(
            $objectStorageHoldingExactlyOneInputMessmitell,
            'inputMessmitell',
            $this->subject
        );
     ...
     * @test
     */
    public function addInputMessmitellToObjectStorageHoldingInputMessmitell()
    {
        $inputMessmitell = new \Wise\WiseDocasysDomainDesigner\Domain\Model\LsgMessmittelInput();
        $inputMessmitellObjectStorageMock = $this->getMockBuilder(\TYPO3\CMS\Extbase\Persistence\ObjectStorage::class)
            ->setMethods(['attach'])
            ->disableOriginalConstructor()
            ->getMock();

        $inputMessmitellObjectStorageMock->expects(self::once())->method('attach')->with(self::equalTo($inputMessmitell));
        $this->inject($this->subject, 'inputMessmitell', $inputMessmitellObjectStorageMock);

        $this->subject->addInputMessmitell($inputMessmitell);
    }

    /**
     * @test
     */
    public function removeInputMessmitellFromObjectStorageHoldingInputMessmitell()
    {
        $inputMessmitell = new \Wise\WiseDocasysDomainDesigner\Domain\Model\LsgMessmittelInput();
        $inputMessmitellObjectStorageMock = $this->getMockBuilder(\TYPO3\CMS\Extbase\Persistence\ObjectStorage::class)
            ->setMethods(['detach'])
        ...
        $inputMessmitellObjectStorageMock->expects(self::once())->method('detach')->with(self::equalTo($inputMessmitell));
        $this->inject($this->subject, 'inputMessmitell', $inputMessmitellObjectStorageMock);

        $this->subject->removeInputMessmitell($inputMessmitell);
