...
class WerkzeugmaschineTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function setMaschinensteuerungForMaschinensteuerungSetsMaschinensteuerung()
    {
        $maschinensteuerungFixture = new \Wise\WiseDocasysDomainDesigner\Domain\Model\Maschinensteuerung();
        $this->subject->setMaschinensteuerung($maschinensteuerungFixture);

        self::assertAttributeEquals(
            $maschinensteuerungFixture,
            'maschinensteuerung',
            $this->subject
        );
