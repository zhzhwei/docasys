...
class RessourcentypTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function getRessourcentypBezeichnungReturnsInitialValueForString()
    {
        self::assertSame(
            '',
            $this->subject->getRessourcentypBezeichnung()
        );
     ...
     * @test
     */
    public function setRessourcentypBezeichnungForStringSetsRessourcentypBezeichnung()
    {
        $this->subject->setRessourcentypBezeichnung('Conceived at T3CON10');
