...
class Loesung extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * @cascade remove
     */
    protected $inputMessmitell = null;
    ...
    protected function initStorageObjects()
    {
        ...
        $this->inputMessmitell = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
     ...
     * 
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\LsgMessmittelInput $inputMessmitell
     * @return void
     */
    public function addInputMessmitell(\Wise\WiseDocasysDomainDesigner\Domain\Model\LsgMessmittelInput $inputMessmitell)
    {
        $this->inputMessmitell->attach($inputMessmitell);
    }

    /**
     * Removes a LsgMessmittelInput
     * 
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\LsgMessmittelInput $inputMessmitellToRemove The LsgMessmittelInput to be removed
     * @return void
     */
    public function removeInputMessmitell(\Wise\WiseDocasysDomainDesigner\Domain\Model\LsgMessmittelInput $inputMessmitellToRemove)
    {
        $this->inputMessmitell->detach($inputMessmitellToRemove);
    }

    /**
     * Returns the inputMessmitell
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\LsgMessmittelInput> $inputMessmitell
     */
    public function getInputMessmitell()
    {
        return $this->inputMessmitell;
    }

    /**
     * Sets the inputMessmitell
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\LsgMessmittelInput> $inputMessmitell
     * @return void
     */
    public function setInputMessmitell(\TYPO3\CMS\Extbase\Persistence\ObjectStorage $inputMessmitell)
    {
        $this->inputMessmitell = $inputMessmitell;
    }
