...
return [
    'ctrl' => [
		...
		'searchFields' => 'loesungsbezeichnung,teilprojektnummer,gestaltungsanforderungen,betrifft_hersteller,betrifft_betreiber,realisierungsrisiko,bemerkung,loesungsklasse,phase_der_thermischen_wirkkette,physikalischer_effekt,invasivitaetsgrad,wartungsintervall,gestaltungsart,repraesentierende_lastfaelle,arbeitsschritte,primaerer_einsatzort,komponentenauswirkung,auswirkung,ablauf,entscheidungen,input_ressource,output_ressource,input_modell,output_modell,input_messmitell,output_messmittel',
    ...
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, loesungsbezeichnung, teilprojektnummer, gestaltungsanforderungen, betrifft_hersteller, betrifft_betreiber, realisierungsrisiko, bemerkung, loesungsklasse, phase_der_thermischen_wirkkette, physikalischer_effekt, invasivitaetsgrad, wartungsintervall, gestaltungsart, repraesentierende_lastfaelle, arbeitsschritte, primaerer_einsatzort, komponentenauswirkung, auswirkung, ablauf, entscheidungen, input_ressource, output_ressource, input_modell, output_modell, input_messmitell, output_messmittel, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'input_messmitell' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_loesung.input_messmitell',
	        'config' => [
			    'type' => 'inline',
