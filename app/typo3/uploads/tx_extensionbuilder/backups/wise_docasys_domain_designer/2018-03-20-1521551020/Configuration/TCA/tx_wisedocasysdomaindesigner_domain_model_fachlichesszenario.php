...
return [
    'ctrl' => [
		...
		'searchFields' => 'losgroesse,genauigkeitsklasse,anwendungsfall,werkstueck',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, losgroesse, genauigkeitsklasse, anwendungsfall, werkstueck',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, losgroesse, genauigkeitsklasse, anwendungsfall, werkstueck, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'anwendungsfall' => [
	        ...
	        'config' => [
			    ...
			    'foreign_field' => 'fachlichesszenario',
			    'maxitems' => 9999,
			    'appearance' => [
			        'collapseAll' => 0,
