...
class FachAnwendungsfall extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
    ...
    /**
     * Returns the szenarioart
     * 
     * @return int $szenarioart
     */
    public function getSzenarioart()
    {
        return $this->szenarioart;
    }

    /**
     * Sets the szenarioart
     * 
     * @param int $szenarioart
     * @return void
     */
    public function setSzenarioart($szenarioart)
    {
        $this->szenarioart = $szenarioart;
    }
}
