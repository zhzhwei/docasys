...
return [
    'ctrl' => [
		...
		'searchFields' => 'bezeichnung,bemerkung,wirkungsgradtendenz',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, bemerkung, wirkungsgradtendenz',
    ],
    'types' => [
        '1' => ['showitem' => '
            --div--; Allgemein, l10n_parent, l10n_diffsource, hidden, bezeichnung, spannweite, bemerkung, 
            --div--; Wirkung, wirkungsgradtendenz,
        '],
    ],
    'columns' => [
		'sys_language_uid' => [
