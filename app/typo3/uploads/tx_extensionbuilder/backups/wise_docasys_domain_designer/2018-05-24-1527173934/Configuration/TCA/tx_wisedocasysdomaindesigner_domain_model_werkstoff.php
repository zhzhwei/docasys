        ...
        'columns' => [
            ...
            'l10n_parent' => [
                ...
                'config' => [
                    ...
                    'foreign_table_where' => 'AND tx_wisedocasysdomaindesigner_domain_model_werkstoff.pid=###CURRENT_PID### AND tx_wisedocasysdomaindesigner_domain_model_werkstoff.sys_language_uid IN (-1,0)',
                ],
            ],
            'l10n_diffsource' => [
                'config' => [
