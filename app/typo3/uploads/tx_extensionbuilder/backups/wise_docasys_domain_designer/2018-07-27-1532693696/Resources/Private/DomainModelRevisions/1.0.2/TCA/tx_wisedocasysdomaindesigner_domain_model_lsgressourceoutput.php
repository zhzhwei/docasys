...
return [
    ...
    'types' => [
		'1' => ['showitem' => '
            l10n_parent, l10n_diffsource, hidden, phase_thermische_wirkkette, struktur, ressourcentyp
        '],
    ],
    'columns' => [
		'sys_language_uid' => [
        ...
        'phase_thermische_wirkkette' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_lsgressourceoutput.phase_thermische_wirkkette',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectSingle',
			    'items' => [
	    ...
	    'struktur' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_lsgressourceoutput.struktur',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectSingle',
			    'items' => [
	    ...
	    'ressourcentyp' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_lsgressourceoutput.ressourcentyp',
	        'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
			    'foreign_table' => '',
