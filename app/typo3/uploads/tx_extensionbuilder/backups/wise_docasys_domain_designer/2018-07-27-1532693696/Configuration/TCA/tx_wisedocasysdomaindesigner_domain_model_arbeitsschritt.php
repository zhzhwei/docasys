...
return [
    'ctrl' => [
		...
		'searchFields' => 'bezeichnung,beschreibung,ist_optional,dauer_in_tagen,dauer_in_tagen_von,dauer_in_tagen_bis,verbesserungspotential_realbetrieb,arbeitsschrittart,bestandteile,erforderliche_ressourcen,erforderliche_messmittel,erforderliche_modelle,input_ressourcen,input_modelle,input_messmittel,input_daten,input_methoden,outcome_ressourcen,outcome_modelle,outcome_messmittel,outcome_daten,outcome_methoden',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, beschreibung, ist_optional, dauer_in_tagen, dauer_in_tagen_von, dauer_in_tagen_bis, verbesserungspotential_realbetrieb, arbeitsschrittart, bestandteile, erforderliche_ressourcen, erforderliche_messmittel, erforderliche_modelle, input_ressourcen, input_modelle, input_messmittel, input_daten, input_methoden, outcome_ressourcen, outcome_modelle, outcome_messmittel, outcome_daten, outcome_methoden',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, beschreibung, ist_optional, dauer_in_tagen, dauer_in_tagen_von, dauer_in_tagen_bis, verbesserungspotential_realbetrieb, arbeitsschrittart, bestandteile, erforderliche_ressourcen, erforderliche_messmittel, erforderliche_modelle, input_ressourcen, input_modelle, input_messmittel, input_daten, input_methoden, outcome_ressourcen, outcome_modelle, outcome_messmittel, outcome_daten, outcome_methoden, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'input_ressourcen' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_arbeitsschritt.input_ressourcen',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectMultipleSideBySide',
			    'foreign_table' => 'tx_wisedocasysdomaindesigner_domain_model_ressource',
			    'MM' => 'tx_wisedocasysdomaindesigner_arbeitsschritt_inputressourcen_ressource_mm',
			    'size' => 10,
			    'autoSizeMax' => 30,
			    'maxitems' => 9999,
			    'multiple' => 0,
	    ...
	    'input_modelle' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_arbeitsschritt.input_modelle',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectMultipleSideBySide',
			    'foreign_table' => 'tx_wisedocasysdomaindesigner_domain_model_modell',
			    'MM' => 'tx_wisedocasysdomaindesigner_arbeitsschritt_inputmodelle_modell_mm',
			    'size' => 10,
			    'autoSizeMax' => 30,
			    'maxitems' => 9999,
			    'multiple' => 0,
	    ...
	    'input_messmittel' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_arbeitsschritt.input_messmittel',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectMultipleSideBySide',
			    'foreign_table' => 'tx_wisedocasysdomaindesigner_domain_model_messverfahren',
			    'MM' => 'tx_wisedocasysdomaindesigner_arbeitsschritt_inputmessmittel_messverfahren_mm',
			    'size' => 10,
			    'autoSizeMax' => 30,
			    'maxitems' => 9999,
			    'multiple' => 0,
	    ...
	    'input_daten' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_arbeitsschritt.input_daten',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectMultipleSideBySide',
	    ...
	    'input_methoden' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_arbeitsschritt.input_methoden',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectMultipleSideBySide',
	    ...
	    'outcome_ressourcen' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_arbeitsschritt.outcome_ressourcen',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectMultipleSideBySide',
			    'foreign_table' => 'tx_wisedocasysdomaindesigner_domain_model_ressource',
			    'MM' => 'tx_wisedocasysdomaindesigner_arbeitsschritt_outcomeressourcen_ressource_mm',
			    'size' => 10,
			    'autoSizeMax' => 30,
			    'maxitems' => 9999,
			    'multiple' => 0,
	    ...
	    'outcome_modelle' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_arbeitsschritt.outcome_modelle',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectMultipleSideBySide',
			    'foreign_table' => 'tx_wisedocasysdomaindesigner_domain_model_modell',
			    'MM' => 'tx_wisedocasysdomaindesigner_arbeitsschritt_outcomemodelle_modell_mm',
			    'size' => 10,
			    'autoSizeMax' => 30,
			    'maxitems' => 9999,
			    'multiple' => 0,
	    ...
	    'outcome_messmittel' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_arbeitsschritt.outcome_messmittel',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectMultipleSideBySide',
			    'foreign_table' => 'tx_wisedocasysdomaindesigner_domain_model_messverfahren',
			    'MM' => 'tx_wisedocasysdomaindesigner_arbeitsschritt_outcomemessmittel_messverfahren_mm',
			    'size' => 10,
			    'autoSizeMax' => 30,
			    'maxitems' => 9999,
			    'multiple' => 0,
	    ...
	    'outcome_daten' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_arbeitsschritt.outcome_daten',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectMultipleSideBySide',
			    'foreign_table' => 'tx_wisedocasysdomaindesigner_domain_model_daten',
			    'MM' => 'tx_wisedocasysdomaindesigner_arbeitsschritt_outcomedaten_daten_mm',
			    'size' => 10,
			    'autoSizeMax' => 30,
			    'maxitems' => 9999,
			    'multiple' => 0,
	    ...
	    'outcome_methoden' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_arbeitsschritt.outcome_methoden',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectMultipleSideBySide',
			    'foreign_table' => 'tx_wisedocasysdomaindesigner_domain_model_methode',
			    'MM' => 'tx_wisedocasysdomaindesigner_arbeitsschritt_outcomemethoden_methode_mm',
			    'size' => 10,
			    'autoSizeMax' => 30,
			    'maxitems' => 9999,
			    'multiple' => 0,
