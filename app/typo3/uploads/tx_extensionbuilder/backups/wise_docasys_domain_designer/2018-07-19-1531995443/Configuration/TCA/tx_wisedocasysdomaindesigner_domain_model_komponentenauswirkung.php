...
return [
    'ctrl' => [
		...
		'searchFields' => 'bemerkung,wirkungsgradtendenz,wirkungsziel,komponente',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bemerkung, wirkungsgradtendenz, wirkungsziel, komponente',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bemerkung, wirkungsgradtendenz, wirkungsziel, komponente, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
