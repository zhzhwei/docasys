<?php
    return [
        'ctrl' => [
            ...
            'cruser_id' => 'cruser_id',
            'versioningWS' => true,
            'default_sortby' => 'ORDER BY zielbezeichnung ASC',
        ...
        'types' => [
            '1' => ['showitem' => '
                --div--; Allgemein, l10n_parent, l10n_diffsource, zielbezeichnung, beschreibung, 
                --div--; Messung, einheit, wertebereich, quantifizierbarkeit, erreichbare_genauigkeit
            '],
        ],
        'columns' => [
            'sys_language_uid' => [
