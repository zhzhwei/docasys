<?php
    return [
        'ctrl' => [
            ...
            'searchFields' => 'verfahrensbezeichnung,untersuchungsart,lastfall,untersuchte_loesung,vorgehen,entscheidungen,untersuchte_komponente,untersuchte_maschine,erforderliche_ressourcen,erforderliche_messmittel,erforderliche_modelle',
        ...
        'interface' => [
            'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, verfahrensbezeichnung, untersuchungsart, lastfall, untersuchte_loesung, vorgehen, entscheidungen, untersuchte_komponente, untersuchte_maschine, erforderliche_ressourcen, erforderliche_messmittel, erforderliche_modelle',
        ],
        'types' => [
            '1' => ['showitem' => '
                --div--; Allgemein, l10n_parent, l10n_diffsource, untersuchungsart, verfahrensbezeichnung,
                --div--; Untersuchungsgegenstand, lastfall, untersuchte_loesung, untersuchte_maschine, untersuchte_komponente,
                --div--; Vorgehen, vorgehen, entscheidungen, erforderliche_ressourcen, erforderliche_messmittel, erforderliche_modelle
            '],
        ],
        'columns' => [
            'sys_language_uid' => [
            ...
            'erforderliche_messmittel' => [
                ...
                'config' => [
                    ...
                    'MM' => 'tx_wisedocasysdomaindesigner_untersuchung_messmittel_mm',
                    'size' => 10,
                    'autoSizeMax' => 30,
                    'maxitems' => 9999,
                    'multiple' => 0,
