...
return [
    'ctrl' => [
		...
		'searchFields' => 'bezeichnung,beschreibung,werkzeuganzahl,werkzeugwechselanteil,zerspanvolumen,werkzeuge,mengenleistung,fertigungsflexibilitaet,werkzeugwechselhaeufigkeit,repraesentierende_lastfaelle,schnittgeschwindigkeit,drehzahlbereich',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, beschreibung, werkzeuganzahl, werkzeugwechselanteil, zerspanvolumen, werkzeuge, mengenleistung, fertigungsflexibilitaet, werkzeugwechselhaeufigkeit, repraesentierende_lastfaelle, schnittgeschwindigkeit, drehzahlbereich',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, beschreibung, werkzeuganzahl, werkzeugwechselanteil, zerspanvolumen, werkzeuge, mengenleistung, fertigungsflexibilitaet, werkzeugwechselhaeufigkeit, repraesentierende_lastfaelle, schnittgeschwindigkeit, drehzahlbereich, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'zerspanvolumen' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_techanwendungsfall.zerspanvolumen',
	        'config' => [
			    'type' => 'input',
			    'size' => 30,
			    'eval' => 'double2'
