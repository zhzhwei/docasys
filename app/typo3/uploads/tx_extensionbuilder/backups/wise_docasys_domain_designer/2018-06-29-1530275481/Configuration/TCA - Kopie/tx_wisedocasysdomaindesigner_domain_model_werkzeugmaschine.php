...
return [
    'ctrl' => [
		...
		'searchFields' => 'bezeichnung,hersteller,preis,kinematik,achsenanzahl,fuehrungsart,schmierungsart,maschinenkomponenten,maschinensteuerung,messkomponente',
    ...
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, hersteller, preis, kinematik, achsenanzahl, fuehrungsart, schmierungsart, maschinenkomponenten, maschinensteuerung, messkomponente',
    ],
    'types' => [
        '1' => ['showitem' => '
            --div--; Allgemein, sys_language_uid, l10n_parent, l10n_diffsource, bezeichnung, hersteller, preis,
            --div--; Struktur, maschinenkomponenten, maschinensteuerung, 
            --div--; Auslegung, kinematik, achsenanzahl, fuehrungsart, schmierungsart,
    ...
    'columns' => [
        ...
        'achsenanzahl' => [
            'exclude' => true,
            'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_werkzeugmaschine.achsenanzahl',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'items' => [
        ...
        'fuehrungsart' => [
            'exclude' => true,
            'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_werkzeugmaschine.fuehrungsart',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'items' => [
