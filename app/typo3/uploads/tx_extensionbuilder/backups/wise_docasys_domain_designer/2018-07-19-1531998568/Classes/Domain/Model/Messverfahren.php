...
class Messverfahren extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * Adds a Ressource
     * 
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\Ressource $messmittel
     * @return void
     */
    public function addMessmittel(\Wise\WiseDocasysDomainDesigner\Domain\Model\Ressource $messmittel)
    {
     ...
     * Removes a Ressource
     * 
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\Ressource $messmittelToRemove The Ressource to be removed
     * @return void
     */
    public function removeMessmittel(\Wise\WiseDocasysDomainDesigner\Domain\Model\Ressource $messmittelToRemove)
    {
     ...
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\Ressource> $messmittel
     */
     ...
     * Sets the messmittel
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\Ressource> $messmittel
     * @return void
     */
