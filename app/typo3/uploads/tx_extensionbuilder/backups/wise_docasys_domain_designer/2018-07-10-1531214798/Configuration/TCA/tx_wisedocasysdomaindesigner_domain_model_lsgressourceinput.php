<?php
    return [
        'ctrl' => [
            ...
            'searchFields' => 'phase_der_thermischen_wirkkette,bemerkung,ressource,struktur,ist_obligatorisch',
        ...
        'interface' => [
            'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, phase_der_thermischen_wirkkette, bemerkung, ressource, struktur, ist_obligatorisch',
        ],
        'types' => [
            '1' => ['showitem' => '
                l10n_parent, l10n_diffsource, phase_der_thermischen_wirkkette, ressource, struktur, ist_obligatorisch, bemerkung,
            '],
        ],
        'columns' => [
            'sys_language_uid' => [
