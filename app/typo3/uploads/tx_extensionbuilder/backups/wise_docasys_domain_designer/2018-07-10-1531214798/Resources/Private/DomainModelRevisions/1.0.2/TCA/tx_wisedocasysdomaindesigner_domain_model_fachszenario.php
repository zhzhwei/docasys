...
return [
    'ctrl' => [
        ...
        'default_sortby' => 'ORDER BY szenariobezeichnung ASC', 
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        'versioningWS' => true,
    ...
    'types' => [
        '1' => ['showitem' => '
            ...
            --div--; Anforderungen, randbedingungen, losgroesse, genauigkeitsklasse, werkstueck,
            --div--; Anwendungsfall, anwendungsfaelle
        '],
    ],
    'columns' => [
        'sys_language_uid' => [
