...
return [
    'ctrl' => [
		...
		'searchFields' => 'verfahrensbezeichnung,untersuchungsart,lastfall',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, verfahrensbezeichnung, untersuchungsart, lastfall',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, verfahrensbezeichnung, untersuchungsart, lastfall, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
