...
class Modell extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * Adds a Loesung
     * 
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\Loesung $erforderlichesModell
     * @return void
     */
    public function addErforderlichesModell(\Wise\WiseDocasysDomainDesigner\Domain\Model\Loesung $erforderlichesModell)
    {
     ...
     * Removes a Loesung
     * 
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\Loesung $erforderlichesModellToRemove The Loesung to be removed
     * @return void
     */
    public function removeErforderlichesModell(\Wise\WiseDocasysDomainDesigner\Domain\Model\Loesung $erforderlichesModellToRemove)
    {
