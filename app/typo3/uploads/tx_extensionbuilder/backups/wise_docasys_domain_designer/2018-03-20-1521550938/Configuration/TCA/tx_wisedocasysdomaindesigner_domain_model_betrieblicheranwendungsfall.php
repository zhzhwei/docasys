...
return [
    'ctrl' => [
        ...
        'label' => 'werkzeugwechselhaeufigkeit',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
		'versioningWS' => true,
		...
		'searchFields' => 'werkzeugwechselhaeufigkeit,fertigungsflexibilitaet,lastfall',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, werkzeugwechselhaeufigkeit, fertigungsflexibilitaet, lastfall',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, werkzeugwechselhaeufigkeit, fertigungsflexibilitaet, lastfall, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'lastfall' => [
	        ...
	        'config' => [
			    ...
			    'MM' => 'tx_wisedocasysdomaindesigner_betrieblicheranwendungsfall_lastfall_mm',
			    'size' => 10,
			    'autoSizeMax' => 30,
			    'maxitems' => 9999,
			    'multiple' => 0,
