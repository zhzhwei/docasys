...
return [
    ...
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, werkzeugmaschinenname, auslegung, hersteller, preis, genauigkeitsklasse, werkzeugmaschinentyp, komponenten, steuerung'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
