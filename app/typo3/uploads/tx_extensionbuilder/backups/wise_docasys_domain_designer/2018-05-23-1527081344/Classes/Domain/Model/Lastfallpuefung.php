...
class Lastfallpuefung extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * parameterpruefungen
     * 
     * @var \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\Parameterprfergebnis>
     * @cascade remove
     */
     ...
     * 
     * @return \Wise\WiseDocasysDomainDesigner\Domain\Model\Untersuchung $untersuchung
     */
     ...
     * @return void
     */
    public function setUntersuchung(\Wise\WiseDocasysDomainDesigner\Domain\Model\Untersuchung $untersuchung)
    {
     ...
     * 
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\Parameterprfergebnis $parameterpruefungen
     * @return void
     */
    public function addParameterpruefungen(\Wise\WiseDocasysDomainDesigner\Domain\Model\Parameterprfergebnis $parameterpruefungen)
    {
     ...
     * 
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\Parameterprfergebnis $parameterpruefungenToRemove The Parameterprfergebnis to be removed
     * @return void
     */
    public function removeParameterpruefungen(\Wise\WiseDocasysDomainDesigner\Domain\Model\Parameterprfergebnis $parameterpruefungenToRemove)
    {
     ...
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\Parameterprfergebnis> parameterpruefungen
     */
     ...
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\Parameterprfergebnis> $parameterpruefungen
     * @return void
     */
