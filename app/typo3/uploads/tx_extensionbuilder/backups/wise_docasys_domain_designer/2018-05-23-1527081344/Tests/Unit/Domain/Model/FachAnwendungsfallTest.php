...
class FachAnwendungsfallTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function setTechnologischenAnwendungsfallForTechAnwendungsfallSetsTechnologischenAnwendungsfall()
    {
        $technologischenAnwendungsfallFixture = new \Wise\WiseDocasysDomainDesigner\Domain\Model\TechAnwendungsfall();
        $this->subject->setTechnologischenAnwendungsfall($technologischenAnwendungsfallFixture);

        self::assertAttributeEquals(
            $technologischenAnwendungsfallFixture,
     ...
     * @test
     */
    public function setWerkzeugmaschineForWerkzeugmaschineSetsWerkzeugmaschine()
    {
        $werkzeugmaschineFixture = new \Wise\WiseDocasysDomainDesigner\Domain\Model\Werkzeugmaschine();
        $this->subject->setWerkzeugmaschine($werkzeugmaschineFixture);

        self::assertAttributeEquals(
            $werkzeugmaschineFixture,
            'werkzeugmaschine',
            $this->subject
        );
     ...
     * @test
     */
    public function setBesitzerForUnternehmenSetsBesitzer()
    {
        $besitzerFixture = new \Wise\WiseDocasysDomainDesigner\Domain\Model\Unternehmen();
        $this->subject->setBesitzer($besitzerFixture);
