...
return [
    'ctrl' => [
        'title'	=> 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_lsgmodelloutput',
        'label' => 'modelltyp',
        ...
        'iconfile' => 'EXT:wise_docasys_domain_designer/Resources/Public/Icons/tx_wisedocasysdomaindesigner_domain_model_lsgmodelloutput.gif'
    ],
    'interface' => [
    ...
    'types' => [
		'1' => ['showitem' => '
            l10n_parent, l10n_diffsource, hidden, phase_thermische_wirkkette, struktur, modelltyp
        '],
    ],
    'columns' => [
		'sys_language_uid' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_wisedocasysdomaindesigner_domain_model_lsgmodelloutput.pid=###CURRENT_PID### AND tx_wisedocasysdomaindesigner_domain_model_lsgmodelloutput.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'phase_thermische_wirkkette' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_lsgmodelloutput.phase_thermische_wirkkette',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectSingle',
			    'items' => [
	    ...
	    'struktur' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_lsgmodelloutput.struktur',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectSingle',
			    'items' => [
	    ...
	    'modelltyp' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_lsgmodelloutput.modelltyp',
	        'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
