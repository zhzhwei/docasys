...
return [
    'ctrl' => [
		...
		'searchFields' => 'unternehmensname,werkzeugmaschinen,ressourcen',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, unternehmensname, werkzeugmaschinen, ressourcen',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, unternehmensname, werkzeugmaschinen, ressourcen, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'ressourcen' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_unternehmen.ressourcen',
	        'config' => [
			    'type' => 'inline',
