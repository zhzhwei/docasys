...
class LastfallpruefungTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function setUntersuchungForObjectStorageContainingUntersuchungSetsUntersuchung()
    {
        $untersuchung = new \Wise\WiseDocasysDomainDesigner\Domain\Model\Untersuchung();
