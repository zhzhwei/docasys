...
return [
    'ctrl' => [
		...
		'searchFields' => 'werkstueckname,abmessungen,kantaenge,form,kontur,toleranzen',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, werkstueckname, abmessungen, kantaenge, form, kontur, toleranzen',
    ],
    'types' => [
        // '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, werkstueckname, abmessungen, kantaenge, form, kontur, toleranzen, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
		'1' => ['showitem' => 'l10n_parent, l10n_diffsource, hidden, werkstueckname, abmessungen, kantaenge, form, kontur, toleranzen'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'kantaenge' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_werkstueck.kantaenge',
	        'config' => [
			    'type' => 'input',
			    'size' => 30,
			    'eval' => 'trim'
