...
return [
    ...
    'types' => [
        // '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, ressourcenart, zweck, ist_buendel, hersteller, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
		'1' => ['showitem' => 'l10n_parent, l10n_diffsource, hidden, bezeichnung, ressourcenart, zweck, ist_buendel, hersteller'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
