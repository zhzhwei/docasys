...
return [
    'ctrl' => [
		...
		'searchFields' => 'bezeichnung,beschreibung,werkzeuganzahl,werkzeugwechselanteil,werkzeugwechselhaeufigkeit,fertigungsflexibilitaet,zerspanvolumen,werkzeuge,lastfall',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, beschreibung, werkzeuganzahl, werkzeugwechselanteil, werkzeugwechselhaeufigkeit, fertigungsflexibilitaet, zerspanvolumen, werkzeuge, lastfall',
    ],
    'types' => [
        // '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, beschreibung, werkzeuganzahl, werkzeugwechselanteil, werkzeugwechselhaeufigkeit, fertigungsflexibilitaet, zerspanvolumen, werkzeuge, lastfall, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
		'1' => ['showitem' => 'l10n_parent, l10n_diffsource, hidden, bezeichnung, beschreibung, werkzeuganzahl, werkzeugwechselanteil, werkzeugwechselhaeufigkeit, fertigungsflexibilitaet, zerspanvolumen, werkzeuge, lastfall'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'lastfall' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_anwendungsfall.lastfall',
	        'config' => [
			    'type' => 'select',
