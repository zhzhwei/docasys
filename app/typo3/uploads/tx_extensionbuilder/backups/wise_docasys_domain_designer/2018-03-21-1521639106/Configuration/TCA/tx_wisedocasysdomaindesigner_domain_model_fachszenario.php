<?php
    return [
        ...
        'types' => [
            // '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, szenariobezeichnung, beschreibung, beispiel, losgroesse, genauigkeitsklasse, randbedingungen, anwendungsfall, werkstueck, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
            '1' => ['showitem' => 'l10n_parent, l10n_diffsource, hidden, szenariobezeichnung, beschreibung, beispiel, losgroesse, genauigkeitsklasse, randbedingungen, anwendungsfall, werkstueck'],
        ],
        'columns' => [
            'sys_language_uid' => [
                'exclude' => true,
