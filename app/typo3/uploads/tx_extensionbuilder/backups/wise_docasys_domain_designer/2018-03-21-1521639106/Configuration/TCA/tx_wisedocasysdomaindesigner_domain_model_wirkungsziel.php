...
return [
    'ctrl' => [
		...
		'searchFields' => 'zielbezeichnung,beschreibung,einheit,wertebereich,quantifizierbarkeit',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, zielbezeichnung, beschreibung, einheit, wertebereich, quantifizierbarkeit',
    ],
    'types' => [
        // '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, zielbezeichnung, beschreibung, einheit, wertebereich, quantifizierbarkeit, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
		'1' => ['showitem' => 'l10n_parent, l10n_diffsource, hidden, zielbezeichnung, beschreibung, einheit, wertebereich, quantifizierbarkeit'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
