...
class Modell extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
    ...
    {
        $this->modelliert = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
    }
     ...
     * @return void
     */
    public function addModelliert(\Wise\WiseDocasysDomainDesigner\Domain\Model\Komponententyp $modelliert)
    {
        $this->modelliert->attach($modelliert);
    }

    /**
     * Removes a Komponententyp
     *
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\Komponententyp $modelliertToRemove The Komponententyp to be removed
     * @return void
     */
    public function removeModelliert(\Wise\WiseDocasysDomainDesigner\Domain\Model\Komponententyp $modelliertToRemove)
    {
        $this->modelliert->detach($modelliertToRemove);
    }

    /**
     * Returns the modelliert
     *
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\Komponententyp> $modelliert
     */
     ...
     * Sets the modelliert
     *
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\Komponententyp> $modelliert
     * @return void
     */
    public function setModelliert(\TYPO3\CMS\Extbase\Persistence\ObjectStorage $modelliert)
    {
