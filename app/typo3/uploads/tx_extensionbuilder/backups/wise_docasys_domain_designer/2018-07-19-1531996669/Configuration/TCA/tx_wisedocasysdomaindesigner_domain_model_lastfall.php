...
return [
    'ctrl' => [
		...
		'searchFields' => 'fallbezeichnung,beschreibung,ist_theoretisch,ist_praktisch,lastfallart',
        'iconfile' => 'EXT:wise_docasys_domain_designer/Resources/Public/Icons/tx_wisedocasysdomaindesigner_domain_model_lastfall.gif'
    ],
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, fallbezeichnung, beschreibung, ist_theoretisch, ist_praktisch, lastfallart',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, fallbezeichnung, beschreibung, ist_theoretisch, ist_praktisch, lastfallart, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
