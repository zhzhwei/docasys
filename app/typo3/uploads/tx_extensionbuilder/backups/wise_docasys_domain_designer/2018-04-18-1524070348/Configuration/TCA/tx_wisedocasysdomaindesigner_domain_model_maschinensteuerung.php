...
return [
    ...
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, identifikator, hersteller, preis, steuerungsname, ist_frei_programmierbar, hat_lizenzkosten, hat_offene_schnittstell, komponententyp'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
