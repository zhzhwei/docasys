...
class Messparameter extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
    ...
    /**
     * Returns the parametereinheit
     * 
     * @return string $parametereinheit
     */
    public function getParametereinheit()
    {
        return $this->parametereinheit;
    }

    /**
     * Sets the parametereinheit
     * 
     * @param string $parametereinheit
     * @return void
     */
    public function setParametereinheit($parametereinheit)
    {
