...
return [
    ...
    'columns' => [
        ...
        'phase_thermische_wirkkette' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_lsgressourceinput.phase_thermische_wirkkette',
	        'config' => [
			    'type' => 'select',
			    'renderType' => 'selectSingle',
			    'items' => [
	    ...
	    'ressourcentyp' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_lsgressourceinput.ressourcentyp',
	        'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
