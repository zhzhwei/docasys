...
class Pruefverfahren extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * @var int
     */
    protected $pruefverfahrensart = 0;
    ...
    /**
     * Returns the pruefverfahrensart
     * 
     * @return int $pruefverfahrensart
     */
    public function getPruefverfahrensart()
    {
        return $this->pruefverfahrensart;
    }

    /**
     * Sets the pruefverfahrensart
     * 
     * @param int $pruefverfahrensart
     * @return void
     */
    public function setPruefverfahrensart($pruefverfahrensart)
    {
        $this->pruefverfahrensart = $pruefverfahrensart;
    }
     ...
     * 
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\Vorgehen $vorgehen
     * @return void
     */
    public function addVorgehen(\Wise\WiseDocasysDomainDesigner\Domain\Model\Vorgehen $vorgehen)
    {
     ...
     * 
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\Vorgehen $vorgehenToRemove The Vorgehen to be removed
     * @return void
     */
    public function removeVorgehen(\Wise\WiseDocasysDomainDesigner\Domain\Model\Vorgehen $vorgehenToRemove)
    {
     ...
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\Vorgehen> vorgehen
     */
     ...
     * Sets the vorgehen
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\Vorgehen> $vorgehen
     * @return void
     */
