...
return [
    ...
    'types' => [
		'1' => ['showitem' => '
            --div--; Allgemein, l10n_parent, l10n_diffsource, hidden, identifikator, steuerungsname, 
            --div--; Eigenschaften, komponententyp, hersteller, preis, ist_frei_programmierbar, hat_lizenzkosten, hat_offene_schnittstell, 
        '],
    ],
    'columns' => [
		'sys_language_uid' => [
