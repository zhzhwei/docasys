...
class MessparameterTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function getParametereinheitReturnsInitialValueForString()
    {
        self::assertSame(
            '',
            $this->subject->getParametereinheit()
        );
     ...
     * @test
     */
    public function setParametereinheitForStringSetsParametereinheit()
    {
        $this->subject->setParametereinheit('Conceived at T3CON10');
