...
class LoesungTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function getKomponententypInputReturnsInitialValueForLsgKomponenteInput()
    {
        $newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        self::assertEquals(
            $newObjectStorage,
     ...
     * @test
     */
    public function setKomponententypInputForObjectStorageContainingLsgKomponenteInputSetsKomponententypInput()
    {
        $komponententypInput = new \Wise\WiseDocasysDomainDesigner\Domain\Model\LsgKomponenteInput();
     ...
     * @test
     */
    public function getKomponententypOutputReturnsInitialValueForLsgKomponenteOutput()
    {
        $newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        self::assertEquals(
            $newObjectStorage,
     ...
     * @test
     */
    public function setKomponententypOutputForObjectStorageContainingLsgKomponenteOutputSetsKomponententypOutput()
    {
        $komponententypOutput = new \Wise\WiseDocasysDomainDesigner\Domain\Model\LsgKomponenteOutput();
     ...
     * @test
     */
    public function getRessourcentypInputReturnsInitialValueForLsgRessourceInput()
    {
        $newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        self::assertEquals(
            $newObjectStorage,
     ...
     * @test
     */
    public function setRessourcentypInputForObjectStorageContainingLsgRessourceInputSetsRessourcentypInput()
    {
        $ressourcentypInput = new \Wise\WiseDocasysDomainDesigner\Domain\Model\LsgRessourceInput();
     ...
     * @test
     */
    public function getRessourcentypOutputReturnsInitialValueForLsgRessourceOutput()
    {
        $newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        self::assertEquals(
            $newObjectStorage,
     ...
     * @test
     */
    public function setRessourcentypOutputForObjectStorageContainingLsgRessourceOutputSetsRessourcentypOutput()
    {
        $ressourcentypOutput = new \Wise\WiseDocasysDomainDesigner\Domain\Model\LsgRessourceOutput();
     ...
     * @test
     */
    public function getMessungstypInputReturnsInitialValueForLsgMessungInput()
    {
        $newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        self::assertEquals(
            $newObjectStorage,
     ...
     * @test
     */
    public function setMessungstypInputForObjectStorageContainingLsgMessungInputSetsMessungstypInput()
    {
        $messungstypInput = new \Wise\WiseDocasysDomainDesigner\Domain\Model\LsgMessungInput();
     ...
     * @test
     */
    public function getMessungstypOutputReturnsInitialValueForLsgMessungOutput()
    {
        $newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        self::assertEquals(
            $newObjectStorage,
     ...
     * @test
     */
    public function setMessungstypOutputForObjectStorageContainingLsgMessungOutputSetsMessungstypOutput()
    {
        $messungstypOutput = new \Wise\WiseDocasysDomainDesigner\Domain\Model\LsgMessungOutput();
     ...
     * @test
     */
    public function getModelltypInputReturnsInitialValueForLsgModellInput()
    {
        $newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        self::assertEquals(
            $newObjectStorage,
     ...
     * @test
     */
    public function setModelltypInputForObjectStorageContainingLsgModellInputSetsModelltypInput()
    {
        $modelltypInput = new \Wise\WiseDocasysDomainDesigner\Domain\Model\LsgModellInput();
     ...
     * @test
     */
    public function getModelltypOutputReturnsInitialValueForLsgModellOutput()
    {
        $newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        self::assertEquals(
            $newObjectStorage,
     ...
     * @test
     */
    public function setModelltypOutputForObjectStorageContainingLsgModellOutputSetsModelltypOutput()
    {
        $modelltypOutput = new \Wise\WiseDocasysDomainDesigner\Domain\Model\LsgModellOutput();
