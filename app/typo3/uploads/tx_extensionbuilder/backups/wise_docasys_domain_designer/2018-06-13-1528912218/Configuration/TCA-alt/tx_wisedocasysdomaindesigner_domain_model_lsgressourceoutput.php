<?php
    return [
        'ctrl' => [
            ...
            'searchFields' => 'phase_der_thermischen_wirkkette,bemerkung,ressource,struktur',
        ...
        'interface' => [
            'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, phase_der_thermischen_wirkkette, bemerkung, ressource, struktur',
        ],
        'types' => [
            '1' => ['showitem' => '
                l10n_parent, l10n_diffsource, phase_der_thermischen_wirkkette, ressource, struktur, bemerkung,
            '],
        ],
        'columns' => [
            'sys_language_uid' => [
            ...
            'phase_der_thermischen_wirkkette' => [
                'exclude' => true,
                'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_lsgressourceoutput.phase_der_thermischen_wirkkette',
                'config' => [
                    'type' => 'select',
                    'renderType' => 'selectSingle',
                    'items' => [
            ...
            'struktur' => [
                ...
                'config' => [
                    ...
                    'foreign_field' => 'lsgressourceoutput',
                    'minitems' => 1,
                    'maxitems' => 1,
                    'items' => [
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:empty', 0],
