...
return [
    'ctrl' => [
		...
		'searchFields' => 'bemerkung,ist_outcome,ist_output,ressource,struktur',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bemerkung, ist_outcome, ist_output, ressource, struktur',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bemerkung, ist_outcome, ist_output, ressource, struktur, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
