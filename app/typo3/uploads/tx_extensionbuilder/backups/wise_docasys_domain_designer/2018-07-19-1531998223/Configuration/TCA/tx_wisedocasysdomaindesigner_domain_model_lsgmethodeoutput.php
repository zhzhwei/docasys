...
return [
    'ctrl' => [
		...
		'searchFields' => 'ist_outcome,ist_output,methode',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, ist_outcome, ist_output, methode',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, ist_outcome, ist_output, methode, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'methode' => [
	        ...
	        'config' => [
			    ...
			    'foreign_field' => 'lsgmethodeoutput',
			    'maxitems' => 9999,
			    'appearance' => [
			        'collapseAll' => 0,
