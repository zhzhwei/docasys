<?php
    return [
        'ctrl' => [
            ...
            'searchFields' => 'bezeichnung,beschreibung,dauer_in_minuten,ist_optional,arbeitsschrittart,bestandteile,erforderliche_ressourcen,erforderliche_messmittel,erforderliche_modelle',
        ...
        'interface' => [
            'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, beschreibung, dauer_in_minuten, ist_optional, arbeitsschrittart, bestandteile, erforderliche_ressourcen, erforderliche_messmittel, erforderliche_modelle',
        ],
        'types' => [
            '1' => ['showitem' => '
                --div--;Allgemein, l10n_parent, l10n_diffsource, bezeichnung, beschreibung,
                --div--; Eigenschaften, dauer_in_minuten, ist_optional, arbeitsschrittart,
                --div--; Bestandteile, bestandteile, 
                --div--; Ressourcen, erforderliche_ressourcen, erforderliche_messmittel, erforderliche_modelle
            '],
        ],
        'columns' => [
            'sys_language_uid' => [
            ...
            'erforderliche_messmittel' => [
                ...
                'config' => [
                    ...
                    'MM' => 'tx_wisedocasysdomaindesigner_arbeitsschritt_messmittel_mm',
                    'size' => 10,
                    'autoSizeMax' => 30,
                    'maxitems' => 9999,
                    'multiple' => 0,
