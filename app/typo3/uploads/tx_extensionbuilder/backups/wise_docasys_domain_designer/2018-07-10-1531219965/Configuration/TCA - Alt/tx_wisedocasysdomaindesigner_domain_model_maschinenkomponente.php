<?php
    return [
        'ctrl' => [
            ...
            'searchFields' => 'komponentenbezeichnung,achsenanzahl,fuehrungsart,antriebsart,typ,kuehlung',
        ...
        'interface' => [
            'showRecordFieldList' => '
            --div--; Allgemein, l10n_parent, l10n_diffsource, hidden, komponentenbezeichnung, typ, 
        ...
        'types' => [
            '1' => ['showitem' => '
                l10n_parent, l10n_diffsource, typ, komponentenbezeichnung, kuehlung
            '],
        ],
        'columns' => [
            'sys_language_uid' => [
            ...
            'achsenanzahl' => [
                'exclude' => true,
                'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_maschinenkomponente.achsenanzahl',
                'config' => [
                    'type' => 'select',
                    'renderType' => 'selectSingle',
                    'items' => [
            ...
            'fuehrungsart' => [
                'exclude' => true,
                'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_maschinenkomponente.fuehrungsart',
                'config' => [
                    'type' => 'select',
                    'renderType' => 'selectSingle',
                    'items' => [
            ...
            'antriebsart' => [
                'exclude' => true,
                'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_maschinenkomponente.antriebsart',
                'config' => [
                    'type' => 'select',
                    'renderType' => 'selectSingle',
                    'items' => [
