<?php
    return [
        'ctrl' => [
            ...
            'tstamp' => 'tstamp',
            'default_sortby' => 'ORDER BY teilprojektnummer, loesungsbezeichnung ASC',
            'crdate' => 'crdate',
            'cruser_id' => 'cruser_id',
            'versioningWS' => true,
            ...
            'searchFields' => 'loesungsbezeichnung,teilprojektnummer,gestaltungsanforderungen,betrifft_hersteller,betrifft_betreiber,realisierungsrisiko,bemerkung,loesungsklasse,phase_der_thermischen_wirkkette,physikalischer_effekt,invasivitaetsgrad,wartungsintervall,loesungsart,gestaltungsart,repraesentierende_lastfaelle,arbeitsschritte,primaerer_einsatzort,komponentenauswirkung,auswirkung,ablauf,entscheidungen,input_ressource,input_modell,input_messmittel,output_ressource,output_modell,output_messmittel,komponentenbedingung',
        ...
        'types' => [
            '1' => ['showitem' => '
                ...
                --div--; Input und Voraussetzungen, input_ressource, input_modell, input_messmittel,
                --div--; Output,                    output_ressource, output_modell, output_messmittel,
                --div--; Bedingungen,               komponentenbedingung,
                ...
                --div--; Anwendung,                 arbeitsschritte, ablauf, entscheidungen, gestaltungsanforderungen,
            '],
        ],
        'columns' => [
            'sys_language_uid' => [
            ...
            'primaerer_einsatzort' => [
                ...
                'config' => [
                    ...
                    'foreign_table_where' => ' ORDER BY bezeichnung ASC',
                    'items' => [
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:empty', 0],
                    ],
                    'appearance' => [
