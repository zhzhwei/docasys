 ...
 * Untersuchung
 */
class Untersuchungsmethode extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
    /**
    ...
    protected function initStorageObjects()
    {
        ...
        $this->messverfahren = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
    }
     ...
     * 
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\Messverfahren $messverfahren
     * @return void
     */
    public function addMessverfahren(\Wise\WiseDocasysDomainDesigner\Domain\Model\Messverfahren $messverfahren)
    {
        $this->messverfahren->attach($messverfahren);
    }

    /**
     * Removes a Messverfahren
     * 
     * @param \Wise\WiseDocasysDomainDesigner\Domain\Model\Messverfahren $messverfahrenToRemove The Messverfahren to be removed
     * @return void
     */
    public function removeMessverfahren(\Wise\WiseDocasysDomainDesigner\Domain\Model\Messverfahren $messverfahrenToRemove)
    {
        $this->messverfahren->detach($messverfahrenToRemove);
    }

    /**
     * Returns the messverfahren
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\Messverfahren> messverfahren
     */
    public function getMessverfahren()
    {
        return $this->messverfahren;
    }

    /**
     * Sets the messverfahren
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Wise\WiseDocasysDomainDesigner\Domain\Model\Messverfahren> $messverfahren
     * @return void
     */
    public function setMessverfahren(\TYPO3\CMS\Extbase\Persistence\ObjectStorage $messverfahren)
    {
        $this->messverfahren = $messverfahren;
    }
}
