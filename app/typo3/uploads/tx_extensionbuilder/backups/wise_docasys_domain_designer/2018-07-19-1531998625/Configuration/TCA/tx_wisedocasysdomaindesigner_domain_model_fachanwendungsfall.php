...
return [
    ...
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, gueltigkeit_von, gueltigkeit_bis, hallenklimatisierung, losgroesse, arbeitszeitregime, toleranzklasse_laengenmasse, toleranzklasse_geradheit, toleranzklasse_ebenheit, toleranzklasse_rechtwinkligkeit, toleranzklasse_symmetrie, toleranzklasse_passungen, werkstoffe, technologischen_anwendungsfall, werkzeugmaschine, besitzer, werkstueck, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
