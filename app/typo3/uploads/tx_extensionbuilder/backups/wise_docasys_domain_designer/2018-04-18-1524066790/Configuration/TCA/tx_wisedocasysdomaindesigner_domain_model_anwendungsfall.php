...
return [
    'ctrl' => [
		...
		'searchFields' => 'lastfaelle,auslegungen',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, lastfaelle, auslegungen',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, lastfaelle, auslegungen, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'auslegungen' => [
	        ...
	        'config' => [
			    ...
			    'MM' => 'tx_wisedocasysdomaindesigner_anwendungsfall_werkzeugmaschinenauslegung_mm',
			    'size' => 10,
			    'autoSizeMax' => 30,
			    'maxitems' => 9999,
			    'multiple' => 0,
			    'wizards' => [
			        ...
			        'add' => [
			            ...
			            'icon' => 'EXT:backend/Resources/Public/Images/FormFieldWizard/wizard_add.gif',
			            'params' => [
			                'table' => 'tx_wisedocasysdomaindesigner_domain_model_werkzeugmaschinenauslegung',
			                'pid' => '###CURRENT_PID###',
			                'setValue' => 'prepend'
			            ],
			        ],
