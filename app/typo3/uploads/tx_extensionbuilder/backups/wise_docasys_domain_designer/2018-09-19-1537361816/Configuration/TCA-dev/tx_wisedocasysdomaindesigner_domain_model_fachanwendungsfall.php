<?php
    return [
        'ctrl' => [
            ...
            'searchFields' => 'bezeichnung,gueltigkeit_von,gueltigkeit_bis,hallenklimatisierung,losgroesse,arbeitszeitregime,werkstoffe,technologischen_anwendungsfall,werkzeugmaschine,besitzer,werkstueck',
        ...
        'interface' => [
            'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, gueltigkeit_von, gueltigkeit_bis, hallenklimatisierung, losgroesse, arbeitszeitregime, toleranzklasse_laengenmasse, toleranzklasse_geradheit, toleranzklasse_ebenheit, toleranzklasse_rechtwinkligkeit, toleranzklasse_symmetrie, toleranzklasse_passungen, werkstoffe, technologischen_anwendungsfall, werkzeugmaschine, besitzer, werkstueck',
        ],
        'types' => [
            '1' => ['showitem' => '
                --div--; Allgemein, l10n_parent, l10n_diffsource, bezeichnung, besitzer, szenarioart, gueltigkeit_von, gueltigkeit_bis,
                --div--; Anwendungsziel, werkstueck, losgroesse, 
                ...
                --div--; Toleranzklassen, toleranzklasse_laengenmasse, toleranzklasse_geradheit, toleranzklasse_ebenheit, toleranzklasse_rechtwinkligkeit, toleranzklasse_symmetrie, toleranzklasse_passungen,   
            '],
        ],   
        'columns' => [
            'sys_language_uid' => [
            ...
            'hallenklimatisierung' => [
                ...
                'config' => [
                    ...
                    'items' => [
                        ...
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:hallenklimatisierung.3', 3],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:hallenklimatisierung.4', 4],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:hallenklimatisierung.5', 5],
                    ],
                    'size' => 1,
                    'maxitems' => 1,
                    'eval' => ''
            ...
            'toleranzklasse_laengenmasse' => [
                ...
                'config' => [
                    ...
                    'items' => [
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:not_applicable', -1],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:empty', 0],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:iso_2768_1.1', 1],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:iso_2768_1.2', 2],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:iso_2768_1.3', 3],
                    ],
                    'size' => 1,
                    'maxitems' => 1,
                    'eval' => ''
            ...
            'toleranzklasse_geradheit' => [
                ...
                'config' => [
                    ...
                    'items' => [
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:not_applicable', -1],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:empty', 0],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:iso_2768_2.1', 1],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:iso_2768_2.2', 2],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:iso_2768_2.3', 3],
                    ],
                    'size' => 1,
                    'maxitems' => 1,
                    'eval' => ''
            ...
            'toleranzklasse_passungen' => [
                ...
                'config' => [
                    ...
                    'items' => [
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:not_applicable', -1],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:empty', 0],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:iso_286.1', 1],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:iso_286.2', 2],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:iso_286.3', 3],
                    ],
                    'size' => 1,
                    'maxitems' => 1,
                    'eval' => ''
            ...
            'szenarioart' => [
                ...
                'config' => [
                    ...
                    'items' => [
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:not_applicable', -1],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:empty', 0],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:szenarioart.1', 1],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:szenarioart.2', 2],
                        ['LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:szenarioart.3', 3],
                    ],
                    'size' => 1,
                    'maxitems' => 1,
                    'eval' => ''
