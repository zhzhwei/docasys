...
return [
    'ctrl' => [
        ...
        'label' => 'empfohlene_prfueverfahren',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
		'versioningWS' => true,
		...
		'searchFields' => 'empfohlene_prfueverfahren',
        'iconfile' => 'EXT:wise_docasys_domain_designer/Resources/Public/Icons/tx_wisedocasysdomaindesigner_domain_model_lastfall.gif'
    ],
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, empfohlene_prfueverfahren',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, empfohlene_prfueverfahren, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
        ...
        'empfohlene_prfueverfahren' => [
	        ...
	        'config' => [
			    ...
			    'MM' => 'tx_wisedocasysdomaindesigner_lastfall_pruefverfahren_mm',
			    'size' => 10,
			    'autoSizeMax' => 30,
			    'maxitems' => 9999,
			    'multiple' => 0,
			    'wizards' => [
			        ...
			        'add' => [
			            ...
			            'params' => [
			                'table' => 'tx_wisedocasysdomaindesigner_domain_model_pruefverfahren',
			                'pid' => '###CURRENT_PID###',
			                'setValue' => 'prepend'
			            ],
			        ],
