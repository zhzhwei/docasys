...
return [
    ...
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, pruefbezeichnung, datum, ort, verantwortlicher, ergebniszusammenfassung, untersuchung, lastfall, parameterpruefungen, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'untersuchung' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_lastfallpuefung.untersuchung',
	        'config' => [
			    'type' => 'inline',
	    ...
	    'lastfall' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_lastfallpuefung.lastfall',
	        'config' => [
			    'type' => 'inline',
	    ...
	    'parameterpruefungen' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db.xlf:tx_wisedocasysdomaindesigner_domain_model_lastfallpuefung.parameterpruefungen',
	        'config' => [
			    'type' => 'inline',
