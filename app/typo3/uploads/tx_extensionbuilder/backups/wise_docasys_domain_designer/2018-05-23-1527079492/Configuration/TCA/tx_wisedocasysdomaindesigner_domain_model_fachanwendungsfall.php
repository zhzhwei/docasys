...
return [
    ...
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, gueltigkeit_von, gueltigkeit_bis, hallenklimatisierung, losgroesse, genauigkeitsklasse, arbeitszeitregime, werkstoffe, technologischen_anwendungsfall, werkzeugmaschine, besitzer, werkstueck, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
