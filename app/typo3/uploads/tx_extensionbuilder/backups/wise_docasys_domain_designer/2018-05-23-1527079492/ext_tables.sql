...
#
# Table structure for table 'tx_wisedocasysdomaindesigner_domain_model_parampruefergebnis'
#
CREATE TABLE tx_wisedocasysdomaindesigner_domain_model_parampruefergebnis (
