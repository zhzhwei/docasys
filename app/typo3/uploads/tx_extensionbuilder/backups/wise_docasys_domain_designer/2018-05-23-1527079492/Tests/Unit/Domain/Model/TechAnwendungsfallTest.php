...
class TechAnwendungsfallTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function setSchnittgeschwindigkeitForSchnittgeschwindigkeitSetsSchnittgeschwindigkeit()
    {
        $schnittgeschwindigkeitFixture = new \Wise\WiseDocasysDomainDesigner\Domain\Model\Schnittgeschwindigkeit();
        $this->subject->setSchnittgeschwindigkeit($schnittgeschwindigkeitFixture);

        self::assertAttributeEquals(
            $schnittgeschwindigkeitFixture,
     ...
     * @test
     */
    public function setDrehzahlbereichForDrehzahlbereichSetsDrehzahlbereich()
    {
        $drehzahlbereichFixture = new \Wise\WiseDocasysDomainDesigner\Domain\Model\Drehzahlbereich();
        $this->subject->setDrehzahlbereich($drehzahlbereichFixture);

        self::assertAttributeEquals(
            $drehzahlbereichFixture,
            'drehzahlbereich',
            $this->subject
        );
