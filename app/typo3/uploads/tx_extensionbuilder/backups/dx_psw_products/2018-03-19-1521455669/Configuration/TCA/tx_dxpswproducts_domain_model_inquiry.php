...
return [
    'ctrl' => [
		...
		'searchFields' => 'name,prename,postalcontact,street,zip,city,callback,telephone,message,email,user,product',
        'iconfile' => 'EXT:dx_psw_products/Resources/Public/Icons/tx_dxpswproducts_domain_model_inquiry.gif'
    ],
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, prename, postalcontact, street, zip, city, callback, telephone, message, email, user, product',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, prename, postalcontact, street, zip, city, callback, telephone, message, email, user, product, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
