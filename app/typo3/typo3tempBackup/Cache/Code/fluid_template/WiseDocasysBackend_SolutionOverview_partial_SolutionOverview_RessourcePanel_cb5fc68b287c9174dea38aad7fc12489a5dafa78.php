<?php
class FluidCache_WiseDocasysBackend_SolutionOverview_partial_SolutionOverview_RessourcePanel_cb5fc68b287c9174dea38aad7fc12489a5dafa78 extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="panel panel-info">
    <div class="panel-heading">
        <span class="pull-right">Ressource</span>
        ';
// Rendering ViewHelper Wise\WiseDocasysBackend\ViewHelpers\Be\EditLinkViewHelper
$arguments1 = array();
$output2 = '';

$output2 .= 'edit[tx_wisedocasysdomaindesigner_domain_model_ressource][';

$output2 .= \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('ressource'), 'uid', $renderingContext);
...
$arguments5 = array();
$arguments5['value'] = \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('ressource'), 'bezeichnung', $renderingContext);
...
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments10 = array();
$arguments10['value'] = \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('ressourceContainer'), 'istObligatorisch', $renderingContext);
...
$output15 .= 'LLL:EXT:wise_docasys_domain_designer/Resources/Private/Language/locallang_db_selectfields.xlf:ressourcenart.';

$output15 .= \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('ressource'), 'ressourcenart', $renderingContext);
