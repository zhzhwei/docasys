...
var assign = _dereq_(63).assign,
    isNumber = _dereq_(63).isNumber,
    omit = _dereq_(63).omit;

var domify = _dereq_(64).domify,
    domQuery = _dereq_(64).query,
    domRemove = _dereq_(64).remove;

var innerSVG = _dereq_(89);

var Diagram = _dereq_(24),
    BpmnModdle = _dereq_(16);


var inherits = _dereq_(62);
...
},{"15":15,"16":16,"2":2,"24":24,"41":41,"45":45,"46":46,"62":62,"63":63,"64":64,"89":89,"9":9}],2:[function(_dereq_,module,exports){
module.exports = {
  __depends__: [
    _dereq_(6),
    _dereq_(11)
...
var every = _dereq_(63).every,
    some = _dereq_(63).some;

var componentsToPath = _dereq_(56).componentsToPath;
...
},{"56":56,"63":63}],4:[function(_dereq_,module,exports){
'use strict';

var inherits = _dereq_(62),
    isObject = _dereq_(63).isObject,
    assign = _dereq_(63).assign,
    forEach = _dereq_(63).forEach;

var BaseRenderer = _dereq_(32),
    TextUtil = _dereq_(58),
    DiUtil = _dereq_(12);

var is = _dereq_(14).is;

var createLine = _dereq_(56).createLine;
...
var domQuery = _dereq_(64).query;

var svgAppend = _dereq_(82),
    svgAttr = _dereq_(84),
    svgCreate = _dereq_(87),
    svgClasses = _dereq_(85);

var rotate = _dereq_(57).rotate,
    transform = _dereq_(57).transform,
    translate = _dereq_(57).translate;
...
},{"12":12,"14":14,"3":3,"32":32,"56":56,"57":57,"58":58,"61":61,"62":62,"63":63,"64":64,"82":82,"84":84,"85":85,"87":87}],5:[function(_dereq_,module,exports){
'use strict';
...
},{"10":10,"12":12,"13":13,"14":14,"58":58,"63":63}],8:[function(_dereq_,module,exports){
'use strict';

var filter = _dereq_(63).filter,
    find = _dereq_(63).find,
    forEach = _dereq_(63).forEach;
...
},{"10":10,"63":63,"77":77}],9:[function(_dereq_,module,exports){
'use strict';
...
},{"46":46,"7":7}],12:[function(_dereq_,module,exports){
'use strict';

var is = _dereq_(14).is,
    getBusinessObject = _dereq_(14).getBusinessObject;

var forEach = _dereq_(63).forEach;
...
},{"14":14,"63":63}],13:[function(_dereq_,module,exports){
'use strict';
...
},{"14":14,"63":63}],14:[function(_dereq_,module,exports){
'use strict';
...
var domDelegate = _dereq_(64).delegate;
...
},{"64":64}],16:[function(_dereq_,module,exports){
module.exports = _dereq_(18);
},{"18":18}],17:[function(_dereq_,module,exports){
'use strict';

var isString = _dereq_(63).isString,
    isFunction = _dereq_(63).isFunction,
    assign = _dereq_(63).assign;

var Moddle = _dereq_(68),
    XmlReader = _dereq_(66),
    XmlWriter = _dereq_(67);
...
},{"63":63,"66":66,"67":67,"68":68}],18:[function(_dereq_,module,exports){
'use strict';
...
},{"17":17,"19":19,"20":20,"21":21,"22":22,"23":23,"63":63}],19:[function(_dereq_,module,exports){
module.exports={
...
var Injector = _dereq_(59).Injector;
...
},{"31":31,"59":59}],26:[function(_dereq_,module,exports){
'use strict';

var isNumber = _dereq_(63).isNumber,
    assign = _dereq_(63).assign,
    forEach = _dereq_(63).forEach,
    every = _dereq_(63).every,
    debounce = _dereq_(63).debounce,
    bind = _dereq_(63).bind,
    reduce = _dereq_(63).reduce;

var Collections = _dereq_(49),
    Elements = _dereq_(50);
...
var svgAppend = _dereq_(82),
    ...
    svgClasses = _dereq_(85),
    svgCreate = _dereq_(87),
    svgTransform = _dereq_(91);

var createMatrix = _dereq_(88).createMatrix;
...
},{"49":49,"50":50,"63":63,"82":82,"84":84,"85":85,"87":87,"88":88,"91":91}],27:[function(_dereq_,module,exports){
'use strict';

var Model = _dereq_(48);
...
},{"48":48,"63":63}],28:[function(_dereq_,module,exports){
'use strict';

var ELEMENT_ID = 'data-element-id';

var svgAttr = _dereq_(84);
...
},{"84":84}],29:[function(_dereq_,module,exports){
'use strict';

var isFunction = _dereq_(63).isFunction,
    isArray = _dereq_(63).isArray,
    isNumber = _dereq_(63).isNumber,
    bind = _dereq_(63).bind,
    assign = _dereq_(63).assign;
...
},{"63":63}],30:[function(_dereq_,module,exports){
'use strict';

var forEach = _dereq_(63).forEach,
    reduce = _dereq_(63).reduce;

var GraphicsUtil = _dereq_(52);

var translate = _dereq_(57).translate;

var domClear = _dereq_(64).clear;

var svgAppend = _dereq_(82),
    svgAttr = _dereq_(84),
    svgClasses = _dereq_(85),
    svgCreate = _dereq_(87),
    svgRemove = _dereq_(90);
...
},{"52":52,"57":57,"63":63,"64":64,"82":82,"84":84,"85":85,"87":87,"90":90}],31:[function(_dereq_,module,exports){
module.exports = {
  __depends__: [ _dereq_(35) ],
  __init__: [ 'canvas' ],
  canvas: [ 'type', _dereq_(26) ],
  elementRegistry: [ 'type', _dereq_(28) ],
  elementFactory: [ 'type', _dereq_(27) ],
  eventBus: [ 'type', _dereq_(29) ],
  graphicsFactory: [ 'type', _dereq_(30) ]
};
...
},{"32":32,"56":56,"62":62,"82":82,"84":84,"87":87}],34:[function(_dereq_,module,exports){
'use strict';
...
},{"63":63}],35:[function(_dereq_,module,exports){
module.exports = {
  __init__: [ 'defaultRenderer' ],
  defaultRenderer: [ 'type', _dereq_(33) ],
  styles: [ 'type', _dereq_(34) ]
};
...
var forEach = _dereq_(63).forEach,
    domDelegate = _dereq_(64).delegate;

var isPrimaryButton = _dereq_(54).isPrimaryButton;
 ...
 * @property {Event} originalEvent
 */
},{"54":54,"56":56,"63":63,"64":64,"82":82,"84":84,"87":87}],37:[function(_dereq_,module,exports){
module.exports = {
  __init__: [ 'interactionEvents' ],
  interactionEvents: [ 'type', _dereq_(36) ]
};
},{"36":36}],38:[function(_dereq_,module,exports){
'use strict';

var getBBox = _dereq_(50).getBBox;
...
},{"50":50,"63":63,"64":64,"82":82,"84":84,"87":87}],39:[function(_dereq_,module,exports){
'use strict';

module.exports = {
  __init__: [ 'outline' ],
  outline: [ 'type', _dereq_(38) ]
};
},{"38":38}],40:[function(_dereq_,module,exports){
'use strict';

var isArray = _dereq_(63).isArray,
    isString = _dereq_(63).isString,
    isObject = _dereq_(63).isObject,
    assign = _dereq_(63).assign,
    forEach = _dereq_(63).forEach,
    find = _dereq_(63).find,
    filter = _dereq_(63).filter,
    matchPattern = _dereq_(63).matchPattern;

var domify = _dereq_(64).domify,
    domClasses = _dereq_(64).classes,
    domAttr = _dereq_(64).attr,
    domRemove = _dereq_(64).remove,
    domClear = _dereq_(64).clear;

var getBBox = _dereq_(50).getBBox;

// document wide unique overlay ids
var ids = new (_dereq_(53))('ov');
...
},{"50":50,"53":53,"63":63,"64":64}],41:[function(_dereq_,module,exports){
module.exports = {
  __init__: [ 'overlays' ],
  overlays: [ 'type', _dereq_(40) ]
};
...
var hasPrimaryModifier = _dereq_(54).hasPrimaryModifier;

var find = _dereq_(63).find;
...
},{"54":54,"63":63}],44:[function(_dereq_,module,exports){
'use strict';
...
module.exports = {
  ...
  selection: [ 'type', _dereq_(42) ],
  selectionVisuals: [ 'type', _dereq_(44) ],
  selectionBehavior: [ 'type', _dereq_(43) ]
};

},{"37":37,"39":39,"42":42,"43":43,"44":44}],46:[function(_dereq_,module,exports){
module.exports = {
  translate: [ 'value', _dereq_(47) ]
};
...
},{"62":62,"63":63,"77":77}],49:[function(_dereq_,module,exports){
'use strict';
...
},{"63":63}],51:[function(_dereq_,module,exports){
'use strict';
...
},{"64":64}],53:[function(_dereq_,module,exports){
'use strict';
...
var getOriginalEvent = _dereq_(51).getOriginal;

var isMac = _dereq_(55).isMac;
...
},{"51":51,"55":55}],55:[function(_dereq_,module,exports){
'use strict';
...
},{"84":84,"87":87}],57:[function(_dereq_,module,exports){
'use strict';

var svgTransform = _dereq_(91);

var createTransform = _dereq_(88).createTransform;
...
},{"88":88,"91":91}],58:[function(_dereq_,module,exports){
'use strict';

var isObject = _dereq_(63).isObject,
    assign = _dereq_(63).assign,
    pick = _dereq_(63).pick,
    forEach = _dereq_(63).forEach,
    reduce = _dereq_(63).reduce;
...
},{"63":63,"82":82,"84":84,"87":87,"90":90}],59:[function(_dereq_,module,exports){
'use strict';
...
var Stack = _dereq_(81),
    SaxParser = _dereq_(80).Parser,
    Moddle = _dereq_(68),
    parseNameNs = _dereq_(73).parseName,
    Types = _dereq_(76),
...
},{"63":63,"65":65,"68":68,"73":73,"76":76,"80":80,"81":81}],67:[function(_dereq_,module,exports){
'use strict';

var map = _dereq_(63).map,
    forEach = _dereq_(63).forEach,
    isString = _dereq_(63).isString,
    filter = _dereq_(63).filter,
    assign = _dereq_(63).assign;

var Types = _dereq_(76),
    parseNameNs = _dereq_(73).parseName,
    common = _dereq_(65),
    hasLowerCaseAlias = common.hasLowerCaseAlias,
    serializeAsType = common.serializeAsType,
...
},{"63":63,"65":65,"73":73,"76":76}],68:[function(_dereq_,module,exports){
module.exports = _dereq_(72);
},{"72":72}],69:[function(_dereq_,module,exports){
'use strict';
...
var pick = _dereq_(63).pick,
    assign = _dereq_(63).assign,
    forEach = _dereq_(63).forEach,
    bind = _dereq_(63).bind;

var parseNameNs = _dereq_(73).parseName;
...
},{"63":63,"73":73}],71:[function(_dereq_,module,exports){
'use strict';
...
var Factory = _dereq_(71),
    Registry = _dereq_(75),
    Properties = _dereq_(74);
...
},{"63":63,"71":71,"73":73,"74":74,"75":75}],73:[function(_dereq_,module,exports){
'use strict';
...
},{"63":63,"70":70,"73":73,"76":76}],76:[function(_dereq_,module,exports){
'use strict';
...
module.exports.Collection = _dereq_(78);
},{"78":78,"79":79}],78:[function(_dereq_,module,exports){
'use strict';
...
},{"92":92}],84:[function(_dereq_,module,exports){
/**
...
},{"84":84,"93":93,"94":94}],88:[function(_dereq_,module,exports){
/**
 * Geometry helpers
 */


var create = _dereq_(87);
...
var clear = _dereq_(86);
var appendTo = _dereq_(83);
var parse = _dereq_(94);
var serialize = _dereq_(95);
...
},{"83":83,"86":86,"94":94,"95":95}],90:[function(_dereq_,module,exports){
