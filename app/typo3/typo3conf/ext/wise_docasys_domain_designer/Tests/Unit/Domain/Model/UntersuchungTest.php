...
class UntersuchungTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function getErforderlicheMessverfahrenReturnsInitialValueForMessverfahren()
    {
        $newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        self::assertEquals(
            $newObjectStorage,
            $this->subject->getErforderlicheMessverfahren()
        );
     ...
     * @test
     */
    public function setErforderlicheMessverfahrenForObjectStorageContainingMessverfahrenSetsErforderlicheMessverfahren()
    {
        $erforderlicheMessverfahren = new \Wise\WiseDocasysDomainDesigner\Domain\Model\Messverfahren();
        $objectStorageHoldingExactlyOneErforderlicheMessverfahren = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        $objectStorageHoldingExactlyOneErforderlicheMessverfahren->attach($erforderlicheMessverfahren);
        $this->subject->setErforderlicheMessverfahren($objectStorageHoldingExactlyOneErforderlicheMessverfahren);

        self::assertAttributeEquals(
            $objectStorageHoldingExactlyOneErforderlicheMessverfahren,
     ...
     * @test
     */
    public function addErforderlicheMessverfahrenToObjectStorageHoldingErforderlicheMessverfahren()
    {
        $erforderlicheMessverfahren = new \Wise\WiseDocasysDomainDesigner\Domain\Model\Messverfahren();
        $erforderlicheMessverfahrenObjectStorageMock = $this->getMockBuilder(\TYPO3\CMS\Extbase\Persistence\ObjectStorage::class)
            ->setMethods(['attach'])
            ->disableOriginalConstructor()
            ->getMock();

        $erforderlicheMessverfahrenObjectStorageMock->expects(self::once())->method('attach')->with(self::equalTo($erforderlicheMessverfahren));
        $this->inject($this->subject, 'erforderlicheMessverfahren', $erforderlicheMessverfahrenObjectStorageMock);

        $this->subject->addErforderlicheMessverfahren($erforderlicheMessverfahren);
    }

    /**
     * @test
     */
    public function removeErforderlicheMessverfahrenFromObjectStorageHoldingErforderlicheMessverfahren()
    {
        $erforderlicheMessverfahren = new \Wise\WiseDocasysDomainDesigner\Domain\Model\Messverfahren();
        $erforderlicheMessverfahrenObjectStorageMock = $this->getMockBuilder(\TYPO3\CMS\Extbase\Persistence\ObjectStorage::class)
            ->setMethods(['detach'])
        ...
        $erforderlicheMessverfahrenObjectStorageMock->expects(self::once())->method('detach')->with(self::equalTo($erforderlicheMessverfahren));
        $this->inject($this->subject, 'erforderlicheMessverfahren', $erforderlicheMessverfahrenObjectStorageMock);

        $this->subject->removeErforderlicheMessverfahren($erforderlicheMessverfahren);
