...
return [
    'ctrl' => [
		...
		'searchFields' => 'bezeichnung,beschreibung,komponentenart,achsenanzahl,fuehrungsart,antriebsart,auf_visualisierung_anzeigen,auf_visualisierung_x,auf_visualisierung_y,auf_visualisierung_breite,auf_visualisierung_hoehe,bestandteile',
    ...
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, beschreibung, komponentenart, achsenanzahl, fuehrungsart, antriebsart, auf_visualisierung_anzeigen, auf_visualisierung_x, auf_visualisierung_y, auf_visualisierung_breite, auf_visualisierung_hoehe, bestandteile',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, beschreibung, komponentenart, achsenanzahl, fuehrungsart, antriebsart, auf_visualisierung_anzeigen, auf_visualisierung_x, auf_visualisierung_y, auf_visualisierung_breite, auf_visualisierung_hoehe, bestandteile, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
