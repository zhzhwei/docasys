...
return [
    ...
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bezeichnung, beschreibung, ist_optional, dauer_in_tagen, dauer_in_tagen_von, dauer_in_tagen_bis, verbesserungspotential_realbetrieb, arbeitsschrittart, bestandteile, i_re, i_mo, i_me, i_da, i_mt, o_re, o_mo, o_me, o_da, o_mt, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
